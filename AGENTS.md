...
shared bottom `AppNav` in progression order: **Foundry → Boosters → Factory → Guide → More**. Storage
...
src/
  ...
  components/
    AppNav/, AppMenu/      ← bottom nav (Foundry → Boosters → Factory → Guide → More) + More sheet
