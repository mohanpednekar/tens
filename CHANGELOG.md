...
- **A Data Lake now draws from its own Storage pool's buffer** whenever that pool is fully
  provisioned and all its disks are full — including while an armed Upgrade Data Stream has paused
  the Data Stream.
