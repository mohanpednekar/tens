...
- The Byte Foundry pre-game screen is no longer a one-time bootstrap — every real Prestige now sends you back through it before your next run begins, resetting your bit balance, capacity, Byte generator, and production multiplier to their starting values, same as your resources/owned tiers. Speed Up and Overclock (the smaller, more frequent soft-resets) are unaffected and still leave the Byte Foundry's progress untouched. A full Reset also sends you back through it, same as before.
