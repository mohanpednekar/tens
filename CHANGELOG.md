...
- **Scale Up now records tiers only when a claim succeeds**, re-reveals recorded tiers at predecessor
  ...
  letting Auto Scale Up remain active while Overclock stays reachable at level 5. Scale Up and
  Overclock cards display raw one-based levels, and Clock Speed milestones no longer add a bonus.
