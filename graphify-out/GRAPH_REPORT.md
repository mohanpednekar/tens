...
## Corpus Check
- 102 files · ~311,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1382 nodes · 3445 edges · 97 communities (78 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48e1bf6d`
...
Cohesion: 0.06
Nodes (45): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_MERGE_BOUNDARIES (+37 more)
...
Cohesion: 0.14
Nodes (31): getIntroKilobyteConversionCost(), isComputeCoreConversionUnlocked(), isComputeUpgradeTurnAvailable(), isIntroConversionUnlocked(), isStorageUnlocked(), isTierUnlocked(), TICKSPEED_AUTOBUYER_COST, ATTENTION_HIGH (+23 more)
...
Cohesion: 0.06
Nodes (69): actFoundry(), activateComputeBoost(), applyIntroProductionDoublingToIntro(), canActivateComputeBoost(), canStackComputeBoost(), combineIntroByte(), eraseAllComputeTokens(), getBiggestComputeTierWaitingOnMerge() (+61 more)
...
Cohesion: 0.05
Nodes (14): canForfeitComputeBoost(), clearIntroCapacityUpgradeQueue(), forfeitComputeBoost(), getAutobuyerUnlockCost(), isAnyComputeMergeInFlight(), releaseDiskCacheBlock(), eraEligibleState(), noOtherUpgradesLeft (+6 more)
...
Cohesion: 0.27
Nodes (12): BareDivider, DataLakePanel(), getVisibleLakeTierIndexes(), LakeList, LakeName, LakeRow, LakeStats, createEmptyDataLakeTier() (+4 more)
...
Cohesion: 0.15
Nodes (16): seedState(), applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), isEraEligible(), Badge, Category (+8 more)
...
Cohesion: 0.08
Nodes (67): seedDataLakeSave(), allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), captureFoundryUpgradeCaps(), createEmptyDataLakes(), createInitialGameState(), eraGame() (+59 more)

### Community 54 - "startBoosterTransfer"
Cohesion: 0.29
Nodes (11): decomposeDataLakeDeposits(), getBoosterTransferPlan(), getDataLakeSubSizeStep(), getDataLakeTransferCapacity(), getDataLakeTransferDurationSeconds(), getDiskLadderSizeBits(), isDiskLadderExhaustedForActivePools(), latchComputeMergePageIfNeeded() (+3 more)
...
Cohesion: 0.23
Nodes (16): wouldAutobuyerStall(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getCostEpochExponent(), getPurchaseBlockSize(), getTierAffordableQuantity(), getTierBulkQuantity() (+8 more)
...
Cohesion: 0.08
Nodes (29): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, canStartDiskWriteCacheMerge(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, decrementFullDiskCount(), floorToDecimals(), formatBitsInNearestSiUnit() (+21 more)
...
Cohesion: 0.20
Nodes (10): canReclaimComputeBoost(), canStartBoosterTransfer(), getComputeBoostMultiplier(), getComputeBoostTierMultiplier(), getDataLakeAvailableUnits(), getNextComputeMergeDurationUpgradeIndex(), tickIntroProduction(), canMerge() (+2 more)
...
Cohesion: 0.08
Nodes (23): COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_CORES_PER_NODE, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED (+15 more)
...
### Community 82 - "engine.computeFlops.test.js"
Cohesion: 0.25
...
## Knowledge Gaps
- **554 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+549 more)
