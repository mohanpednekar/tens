...
## Corpus Check
- 107 files · ~395,598 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1565 nodes · 3953 edges · 94 communities (70 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `babd6739`
...
Cohesion: 0.07
Nodes (32): FILL_MULTIPLIER_TAP_CAP_PERCENT, ActionsRow, BalanceText, clampGaugeValue(), DataStreamCard, FillableStatCard, gaugeArcPath(), GaugeBaseArc (+24 more)
...
Cohesion: 0.10
Nodes (19): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, DATA_LAKE_OVERFLOW_MAX_PERCENT, DATA_LAKE_OVERFLOW_MIN_PERCENT (+11 more)
...
Cohesion: 0.08
Nodes (61): createEmptyDataLakes(), createEmptyDataLakeTier(), COMPUTE_BOOST_TIER_FIELDS, COMPUTE_CORES_PER_NODE, INTRO_CAPACITY_CAP_BITS, MONEY_STARTING_AMOUNT, PRESTIGE_UNBOUNDED_MIN_COUNT, applyDevGameStateJson() (+53 more)
...
Cohesion: 0.05
Nodes (78): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), canForfeitComputeBoost(), captureFoundryUpgradeCaps(), clearIntroCapacityUpgradeQueue() (+70 more)
...
Cohesion: 0.10
Nodes (16): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_BOOST_PRESETS, COMPUTE_ENTITY_CAP (+8 more)

### Community 54 - "MilestonesPage/index.jsx"
Cohesion: 0.12
Nodes (21): seedState(), applyAutobuyerMilestones(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), eraGame(), getAutobuyerUnlockMilestone(), getEonsAwarded(), getFlopsAutobuyerUnlockEra() (+13 more)
...
Cohesion: 0.10
Nodes (22): MUSEUM_PIN_CAP, buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage(), FREE_SLOT_COUNT, SUPPORTER_SLOT_COUNT, SUPPORTER_UNLOCK_CODE, buildSparklinePath(), CodeForm (+14 more)

### Community 58 - "clampNonNegative"
Cohesion: 0.09
Nodes (59): actTickspeed(), buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyGlobalTickspeedMultiplier(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus() (+51 more)
...
Cohesion: 0.25
Nodes (9): flooredBitsLabel(), floorToDecimals(), formatBitsInNearestSiUnit(), formatBitsInNearestUnit(), formatMemoryAmount(), getMemoryUnit(), getSiByteUnit(), formatMemoryBalance() (+1 more)

### Community 65 - "engine.test.js"
Cohesion: 0.04
Nodes (38): getComputeBoostMultiplier(), getComputeBoostTierMultiplier(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction(), getDataStreamMultiplierPercent() (+30 more)

### Community 66 - "getStoragePoolBandwidth"
Cohesion: 0.14
Nodes (23): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getPoolBufferCapacity(), getPoolEffectMultiplier() (+15 more)

### Community 68 - "navAttention.test.js"
Cohesion: 0.10
Nodes (21): seedDataLakeSave(), allResourceIds(), createInitialGameState(), unlockedLastTierState(), withOwned(), AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_MERGE_RATIO (+13 more)

### Community 69 - "run-simulation.mjs"
Cohesion: 0.08
Nodes (44): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+36 more)
...
Cohesion: 0.17
Nodes (16): getDataLakeSubSize(), getDataLakeTierIndex(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskRequiredTierLevel(), getDiskSize(), getIdleDiskLiquidationSizes(), getMaxActiveDiskLadderStep() (+8 more)
...
### Community 96 - "actFoundry"
Cohesion: 0.18
Nodes (27): actFoundry(), activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField() (+19 more)

### Community 97 - "getDiskSizesToShow"
Cohesion: 0.29
...
## Knowledge Gaps
- **629 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+624 more)
