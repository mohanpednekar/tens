...
## Corpus Check
- 108 files · ~422,035 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1590 nodes · 4002 edges · 100 communities (81 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8532dd04`
...
Cohesion: 0.09
Nodes (42): enableAutoMerge(), isAutoMergeCloudsIntoDatacenterUnlockAvailable(), isAutoMergeClustersIntoNetworkUnlockAvailable(), isAutoMergeCoresIntoNodeUnlockAvailable(), isAutoMergeDatacentersIntoSupercomputerUnlockAvailable(), isAutoMergeFabricsIntoCloudUnlockAvailable(), isAutoMergeGridsIntoFabricUnlockAvailable(), isAutoMergeNetworksIntoGridUnlockAvailable() (+34 more)

### Community 2 - "useIncrementalGame.js"
Cohesion: 0.05
Nodes (49): applyOfflineProgress(), canForfeitComputeBoost(), clearDiskBuildQueue(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud (+41 more)
...
Cohesion: 0.05
Nodes (57): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS (+49 more)
...
Cohesion: 0.14
Nodes (27): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyHyperscaler(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer() (+19 more)
...
### Community 12 - "actFoundry"
Cohesion: 0.17
Nodes (15): actFoundry(), combineIntroByte(), eraseAllComputeTokens(), getPoolCapacityUnlockThresholdBits(), getVisibleStoragePoolCount(), isInvestProgressBelowCap(), latchMainGameUnlocked(), pickIntroCapacityMilestone() (+7 more)
...
### Community 14 - "getPoolBufferBits"
Cohesion: 0.28
Nodes (9): getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction(), getDataStreamMultiplierPercent(), getFillMultiplierPercent(), getPoolBaseMultiplierPercent(), getPoolBufferBits(), getPoolBufferFillFraction() (+1 more)
...
Cohesion: 0.10
Nodes (29): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), flooredBitsLabel(), floorToDecimals(), formatAmount(), formatBitsInNearestSiUnit(), formatComputeFlopsBoost() (+21 more)
...
### Community 21 - "createInitialGameState"
Cohesion: 0.22
...
Cohesion: 0.23
Nodes (14): wouldAutobuyerStall(), buyTierQuantity(), convertIntroBitsToKilobytes(), getCostEpochExponent(), getIntroKilobyteConversionCost(), getTierAffordableQuantity(), getTierBulkQuantity(), getTierCost() (+6 more)

### Community 24 - "run-simulation.mjs"
Cohesion: 0.13
Nodes (22): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+14 more)

### Community 25 - "navAttention.test.js"
Cohesion: 0.10
Nodes (20): vitest, AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_FIRST_TIER_COST_PP, COMPUTE_FLOPS_REVEAL_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE (+12 more)
...
Cohesion: 0.07
Nodes (34): styled-components, GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), AppMenu(), Backdrop, Icon, MenuButton (+26 more)
...
Cohesion: 0.17
Nodes (19): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getDiskProvisionPassesCollected(), getDiskSize(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost() (+11 more)
...
### Community 38 - "isProductionFrozen"
Cohesion: 0.25
Nodes (16): buyGlobalTickspeedMultiplier(), buyTier(), getGlobalTickspeedMultiplierCost(), getTierSpendableAmount(), isGlobalTickspeedMultiplierUnlocked(), isProductionFrozen(), isTierUnlocked(), getTiersAttentionLevel() (+8 more)

### Community 39 - "storage.test.js"
Cohesion: 0.14
Nodes (23): App(), buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage(), buildResetActiveSlotConfirmMessage(), buildResetByteFoundryConfirmMessage(), completeDummySupporterPurchase(), FREE_SLOT_COUNT, getActiveSlotDisplayName() (+15 more)

### Community 40 - "generate-pwa-icons.mjs"
Cohesion: 0.25
Nodes (5): sharp, faviconSizes, faviconSvg, GRADIENT_STOPS, targets

### Community 41 - "getUnlockedStoragePoolCount"
Cohesion: 0.21
...
Cohesion: 0.14
Nodes (26): buyTickspeedMultiplier(), countGlobalTickspeedMilestones(), getAutoPrestigeAttemptRate(), getComputeBoostMultiplier(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierId(), getLastTierXpTickspeedMultiplier() (+18 more)

### Community 44 - "isDevModeActive"
Cohesion: 0.22
...
### Community 45 - "isDiskPullEligible"
Cohesion: 0.25
...
### Community 46 - "ConfirmDialog/index.jsx"
Cohesion: 0.11
...
### Community 66 - "save-migration/index.js"
Cohesion: 0.36
...
### Community 67 - "StoragePage/index.jsx"
Cohesion: 0.29
...
## Knowledge Gaps
- **672 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+667 more)
...
- **Why does `styled-components` connect `App.jsx` to `SettingsPage/index.jsx`, `MainPage/index.jsx`, `DataLakePanel/index.jsx`, `StoragePage/index.jsx`, `ComputePage/index.jsx`, `ByteFoundryPage/index.jsx`, `DiskArrayRow/index.jsx`, `ConfirmDialog/index.jsx`, `DevModePage/index.jsx`, `MilestonesPage/index.jsx`, `ComputeFlopsPage/index.jsx`, `InfoPage/index.jsx`, `package.json`, `Button/index.jsx`?**
...
- **Why does `vitest` connect `navAttention.test.js` to `capacitorConfig.test.js`, `save-migration/index.js`, `layers.js`, `storage.test.js`, `App.test.jsx`, `engine.test.js`, `package.json`?**
