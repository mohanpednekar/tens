...
## Corpus Check
- 108 files · ~440,641 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1607 nodes · 3960 edges · 103 communities (84 shown, 17 thin omitted)
...
### Community 1 - "convertIntroBitsToKilobytes"
Cohesion: 0.32
...
Cohesion: 0.04
Nodes (50): captureFoundryUpgradeCaps(), clearDiskBuildQueue(), clearIntroCapacityUpgradeQueue(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud (+42 more)
...
Cohesion: 0.06
Nodes (53): AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_FLOPS_TIER_BY_ID, COMPUTE_FLOPS_TIER_DEFINITIONS (+45 more)

### Community 6 - "getUnlockedStoragePoolCount"
Cohesion: 0.20
Nodes (16): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getPoolBufferCapacity(), getPoolIndexForDiskSize() (+8 more)
...
### Community 8 - "tickComputeMergeBoundary"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (24): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_OVERFLOW_SEGMENT_LIMIT, fixedMemoryAmountFormatter, isMemoryCapacityAtCap(), isPoolCapacityUpgradeAvailable() (+16 more)

### Community 11 - "MainPage"
Cohesion: 0.13
Nodes (25): formatAsCleanBytesIfExactMultiple(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getAutoPrestigeAttemptRate(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier() (+17 more)
...
Cohesion: 0.09
Nodes (34): CacheBlock, CacheBlocksRow, CacheFillIndicator, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, pullPulse (+26 more)

### Community 14 - "ByteFoundryPage"
Cohesion: 0.21
Nodes (14): formatDiskSize, getPoolBaseMultiplierPercent(), getPoolBufferBits(), getPoolBufferFillFraction(), getPoolEffectMultiplier(), getPoolMultiplierPercent(), getPoolTapBonusPercent(), tapPoolBuffer() (+6 more)
...
Cohesion: 0.14
Nodes (12): react, Actions, Body, Card, ConfirmDialog(), Overlay, Title, Body (+4 more)
...
### Community 18 - "getIntroProductionRate"
Cohesion: 0.22
Nodes (9): getComputeBoostMultiplier(), getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction(), getDataStreamMultiplierPercent(), getDataStreamSpeedBytesPerSecond(), getFillMultiplierPercent(), getIntroProductionRate() (+1 more)
...
### Community 21 - "StoragePage/index.jsx"
Cohesion: 0.29
...
Cohesion: 0.08
Nodes (21): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_BOOST_PRESETS, COMPUTE_CORES_PER_NODE (+13 more)

### Community 23 - "run-simulation.mjs"
Cohesion: 0.11
Nodes (35): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+27 more)
...
Cohesion: 0.08
Nodes (29): version, formatBitsInNearestUnit(), getAutobuyerUnlockMilestone(), getOverclockRequirement(), getTierTickspeedAutobuyerMilestone(), TIER_UNLOCK_PREV_LEVEL_REQUIREMENT, CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER (+21 more)
...
Cohesion: 0.31
Nodes (10): activateComputeBoost(), canActivateComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierField(), isComputeBoostTurnAvailable(), isComputeUpgradeAvailable(), isStackComputeBoostTurnAvailable() (+2 more)
...
Cohesion: 0.22
Nodes (17): getDiskCost(), getDiskProvisionPassesCollected(), getDiskProvisionPassesRequired(), getDiskReplayPassAllowance(), getDiskSize(), getMaxActiveDiskLadderStep(), getPoolCacheReservationBits(), isDiskBuildBelowCap() (+9 more)
...
Cohesion: 0.08
Nodes (66): applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createEmptyDataLakeTier(), eraGame(), applyDevGameStateJson(), applyPendingComputeGrants(), buildClearSlotConfirmMessage() (+58 more)
...
Cohesion: 0.18
Nodes (14): web-vitals, App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), isComputeFlopsPageRevealed(), getComputeFlopsAttentionLevel(), getNavAttention() (+6 more)

### Community 45 - "buyGlobalTickspeedMultiplier"
Cohesion: 0.67
...
Cohesion: 0.32
Nodes (7): seedState(), seedDataLakeSave(), allResourceIds(), applyAutobuyerMilestones(), createInitialGameState(), prestigeGame(), withIntro()
...
Cohesion: 0.21
Nodes (12): actFoundry(), combineIntroByte(), eraseAllComputeTokens(), getPoolCapacityUnlockThresholdBits(), getVisibleStoragePoolCount(), isMemoryCapacityUpgradeAvailable(), isStorageUnlocked(), latchMainGameUnlocked() (+4 more)
...
- **Why does `styled-components` connect `ComputeFlopsPage/index.jsx` to `tokens.js`, `SettingsPage/index.jsx`, `AppNav/index.jsx`, `DataLakePanel/index.jsx`, `MainPage/index.jsx`, `ComputePage/index.jsx`, `AppMenu/index.jsx`, `ByteFoundryPage/index.jsx`, `App.jsx`, `DiskArrayRow/index.jsx`, `MilestonesPage/index.jsx`, `ConfirmDialog/index.jsx`, `DevModePage/index.jsx`, `Button/index.jsx`, `StoragePage/index.jsx`, `InfoPage/index.jsx`, `package.json`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Design history & rationale` connect `Design history & rationale` to `Automation workflows`, `Documentation`, `Save persistence`, `Tens`, `Testing`, `Economy model`?**
