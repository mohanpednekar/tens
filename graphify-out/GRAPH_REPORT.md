...
## Corpus Check
- 107 files · ~334,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1479 nodes · 3736 edges · 95 communities (76 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7440dde1`
...
Cohesion: 0.06
Nodes (39): floorToDecimals(), formatBitsInNearestSiUnit(), formatBitsInNearestUnit(), formatMemoryAmount(), getMemoryUnit(), getSiByteUnit(), ActionsRow, BalanceText (+31 more)

### Community 4 - "tokens.js"
Cohesion: 0.10
Nodes (23): AA_LARGE_TEXT, AA_NORMAL_TEXT, AA_UI_COMPONENT, getContrastRatio(), hexToRgb(), relativeLuminance(), srgbChannelToLinear(), GlobalStyle (+15 more)
...
### Community 8 - "App.jsx"
Cohesion: 0.12
Nodes (16): GATE_EXEMPT_PAGES, PageShell, AppMenu(), Backdrop, Icon, MenuButton, Sheet, SheetTitle (+8 more)
...
Cohesion: 0.05
Nodes (57): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), captureFoundryUpgradeCaps(), clearIntroCapacityUpgradeQueue(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter (+49 more)
...
### Community 48 - "buyTierQuantity"
Cohesion: 0.22
Nodes (16): actMainBuys(), wouldAutobuyerStall(), buyTier(), buyTierQuantity(), getCostEpochExponent(), getIntroKilobyteConversionCost(), getTierAffordableQuantity(), getTierBulkQuantity() (+8 more)
...
Cohesion: 0.06
Nodes (31): COMPUTE_ENTITY_CAP, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow, canMerge(), CompactButton (+23 more)

### Community 51 - "MilestonesPage/index.jsx"
Cohesion: 0.15
Nodes (17): applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), isEraEligible(), ERA_ELIGIBILITY_PP, InfoPage(), Badge (+9 more)
...
Cohesion: 0.07
Nodes (73): seedState(), App(), resolveInitialThemeMode(), allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createEmptyDataLakeTier() (+65 more)
...
Cohesion: 0.11
Nodes (23): formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), MUSEUM_PIN_CAP, RESOURCE_SYMBOL(), formatCost(), buildSparklinePath() (+15 more)

### Community 58 - "navAttention.js"
Cohesion: 0.12
Nodes (39): getSmartAutobuyerCost(), isComputeCoreConversionUnlocked(), isComputeFlopsPageRevealed(), isGlobalTickspeedMultiplierUnlocked(), isTierUnlocked(), BYTES_ID, COMPUTE_MERGE_RATIO, INTRO_BYTE_COMBINE_COST (+31 more)
...
Cohesion: 0.10
Nodes (33): applyIntroProductionDoublingToIntro(), combineIntroByte(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskRedeemTierName(), getDiskSize(), getDiskSizesToShow(), getEffectiveComputeBandwidthSacrificeIndex() (+25 more)
...
Cohesion: 0.11
Nodes (15): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_BOOST_PRESETS, DATA_LAKE_CAPACITY_MAX_LEVEL (+7 more)

### Community 65 - "DataLakePanel/index.jsx"
Cohesion: 0.10
Nodes (40): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeGrid, LakeHeaderRow, LakeName (+32 more)

### Community 66 - "clampNonNegative"
Cohesion: 0.13
Nodes (34): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyComputeFlopsTier(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer() (+26 more)
...
### Community 68 - "upgradePoolCapacity"
Cohesion: 0.40
...
Cohesion: 0.15
Nodes (16): Money, formatAmount(), formatComputeFlopsBoost(), formatComputeFlopsTotal(), COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_REVEAL_PP, ComputeFlopsPage(), FlopsHero (+8 more)

### Community 70 - "INTRO_COMPUTE_CORE_UNLOCK_CAPACITY"
Cohesion: 0.50
Nodes (3): seedDataLakeSave(), DISK_ARRAY_LADDER_CAP, INTRO_COMPUTE_CORE_UNLOCK_CAPACITY

### Community 73 - "InfoPage/index.jsx"
Cohesion: 0.12
Nodes (16): COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_CORES_PER_NODE, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED (+8 more)

### Community 74 - "Testing"
Cohesion: 0.12
Nodes (17): Compute Boost base presets: fixing a total-extra-production ordering bug, Data Lake Boosters: spending real deposits, not a separate "used" ledger, Data Lake Boosters, take two: from a spendable balance to a live transfer pipe, Data Lake capacity-doubling cost: fixing a unit-count/real-bits conflation found while wiring up the Byte-scale display, Data Lake capacity doubling reinstated, redesigned as a level-based ladder with a hard cap, Data Lake capacity doubling removed: the cap was always a fixed physical ceiling, not a lever, Data Lake refill gating: staged 9 → 99 → 999 capacity from disk-array completion, Disk Cache: always-full reserve, whole-block Memory transfers, no pour into disks (issue #382) (+9 more)
...
### Community 79 - "engine.test.js"
Cohesion: 0.03
Nodes (63): applyOfflineProgress(), canForfeitComputeBoost(), convertIntroBitsToKilobytes(), doubleDataLakeCapacity(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer (+55 more)

### Community 80 - "getStoragePoolBandwidth"
Cohesion: 0.20
Nodes (15): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskCost(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getNextDiskLadderSize(), getPoolBufferBits() (+7 more)
...
Cohesion: 0.16
Nodes (26): actTickspeed(), buyGlobalTickspeedMultiplier(), buyTickspeedMultiplier(), consumeXpForLastTierTickspeed(), countGlobalTickspeedMilestones(), getAutoPrestigeAttemptRate(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedMultiplierCost() (+18 more)
