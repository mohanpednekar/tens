...
## Corpus Check
- 108 files · ~415,500 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1579 nodes · 3981 edges · 102 communities (83 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23642110`
...
Cohesion: 0.19
Nodes (21): applyFlopsAutobuyerMilestones(), createEmptyDataLakes(), createEmptyDataLakeTier(), normalizePoolMemoryCapacity(), applyDevGameStateJson(), applyPendingComputeGrants(), buildDefaultMeta(), coerceMeta() (+13 more)
...
Cohesion: 0.05
Nodes (57): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_FLOPS_TIER_BY_ID (+49 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.07
Nodes (45): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), isBandwidthAvailable() (+37 more)
...
Cohesion: 0.14
Nodes (24): getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolBufferCapacity(), getPoolEffectMultiplier(), getPoolIndexForDiskSize() (+16 more)
...
### Community 19 - "isMemoryCapacityUpgradeAvailable"
Cohesion: 0.29
Nodes (8): eraseAllComputeTokens(), isMemoryCapacityUpgradeAvailable(), isStorageUnlocked(), latchMainGameUnlocked(), rewindOneIntroProductionClaim(), rollbackComputeFundedBandwidth(), tickQueuedCapacityUpgrade(), upgradePoolCapacity()

### Community 20 - "engine.test.js"
Cohesion: 0.05
Nodes (22): canForfeitComputeBoost(), clearIntroCapacityUpgradeQueue(), forfeitComputeBoost(), getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction(), getFillMultiplierPercent(), getNextSiDoubledValue() (+14 more)
...
Cohesion: 0.18
Nodes (26): actTickspeed(), wouldAutobuyerStall(), buyTickspeedMultiplier(), buyTier(), buyTierQuantity(), consumeXpForLastTierTickspeed(), convertIntroBitsToKilobytes(), getIntroKilobyteConversionCost() (+18 more)

### Community 48 - "ComputePage"
Cohesion: 0.24
Nodes (17): activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostMultiplier(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField() (+9 more)
...
Cohesion: 0.06
Nodes (46): applyOfflineProgress(), clearDiskBuildQueue(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud, enableAutoMergeGridsIntoFabric (+38 more)
...
Cohesion: 0.18
Nodes (13): getFlopsAutobuyerUnlockEra(), isEraEligible(), isUnboundedPrestigeUnlocked(), Badge, Category, CategoryHeading, Header, List (+5 more)

### Community 55 - "browserslist"
Cohesion: 0.67
Nodes (3): browserslist, development, production

### Community 56 - "formatCurrency"
Cohesion: 0.57
...
Cohesion: 0.08
Nodes (29): applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getTierTickspeedAutobuyerMilestone(), CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP (+21 more)
...
Cohesion: 0.07
Nodes (48): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, pullPulse (+40 more)

### Community 62 - "provisionDisk"
Cohesion: 0.31
Nodes (9): getDiskProvisionPassesCollected(), getDiskSize(), getMaxActiveDiskLadderStep(), getPoolBufferBits(), isDiskBuildBelowCap(), isDiskLadderExhaustedForActivePools(), isProvisionDiskAvailable(), provisionDisk() (+1 more)
...
### Community 65 - "isTierUnlocked"
Cohesion: 0.29
Nodes (11): actSoftResets(), getOverclockRequirement(), getSpeedUpRequirement(), isTierUnlocked(), overclockGame(), speedUpGame(), hasAffordableFullLevel(), hasOverclockAvailable() (+3 more)

### Community 66 - "engine.js"
Cohesion: 0.08
Nodes (38): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_OVERFLOW_SEGMENT_LIMIT, flooredBitsLabel(), floorToDecimals(), formatBitsInNearestSiUnit() (+30 more)
...
Cohesion: 0.11
Nodes (19): AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_FIRST_TIER_COST_PP, COMPUTE_FLOPS_REVEAL_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST (+11 more)

### Community 69 - "run-simulation.mjs"
Cohesion: 0.10
Nodes (26): actFoundry(), actMainBuys(), actPlayer(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+18 more)
...
### Community 72 - "storage.test.js"
Cohesion: 0.17
Nodes (17): buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage(), completeDummySupporterPurchase(), FREE_SLOT_COUNT, grantSupporterUnlock(), isSupporterUnlocked(), loadSavesMeta(), normalizeUnlockCode() (+9 more)
...
### Community 75 - "isDevModeActive"
Cohesion: 0.22
Nodes (16): clearAllSaveProgress(), clearDevGameState(), clearGameState(), clearSaveSlot(), discardIncompatibleActiveSaveIfNeeded(), getActiveSlotId(), hasStoredStateForSlot(), isDevModeActive() (+8 more)
...
### Community 86 - "createInitialGameState"
Cohesion: 0.22
Nodes (10): seedState(), seedDataLakeSave(), allResourceIds(), buildEraIntroReset(), captureFoundryUpgradeCaps(), createInitialGameState(), eraGame(), mergeFoundryUpgradeCaps() (+2 more)

### Community 87 - "MainPage"
Cohesion: 0.13
Nodes (21): countGlobalTickspeedMilestones(), getAutoPrestigeAttemptRate(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getNextBytePowerProgressFraction(), getOverclockMultiplier(), getPrestigeProductionMultiplier() (+13 more)
...
## Knowledge Gaps
- **663 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+658 more)
...
- **Why does `react` connect `react` to `App.jsx`, `MainPage/index.jsx`, `ByteFoundryPage/index.jsx`, `styled-components`, `package.json`, `useIncrementalGame.js`, `ComputePage/index.jsx`, `DevModePage/index.jsx`, `SettingsPage/index.jsx`, `Button/index.jsx`?**
