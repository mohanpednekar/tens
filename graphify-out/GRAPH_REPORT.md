...
## Corpus Check
- 107 files · ~392,829 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1563 nodes · 3953 edges · 102 communities (78 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65a9bb21`
...
### Community 0 - "isIdleDiskLiquidationTurnAvailable"
Cohesion: 0.18
Nodes (15): getDataLakeSubSize(), getDataLakeTierIndex(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskRequiredTierLevel(), getIdleDiskLiquidationSizes(), getNextDiskLadderSize(), isAnyDataLakeCapacityDoublingAvailable() (+7 more)
...
Cohesion: 0.07
Nodes (34): DATA_LAKE_OVERFLOW_MIN_PERCENT, ActionsRow, BalanceText, clampGaugeValue(), clampPercent(), DataStreamCard, FillableStatCard, fractionToBottomAngle() (+26 more)
...
Cohesion: 0.10
Nodes (19): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER, DATA_LAKE_OVERFLOW_MAX_PERCENT, DATA_LAKE_SUB_SIZE_DISK_CAPS (+11 more)
...
Cohesion: 0.09
Nodes (33): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+25 more)
...
Cohesion: 0.12
Nodes (27): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), formatAmount(), formatComputeFlopsBoost(), formatComputeFlopsTotal(), getComputeFlopsTierCost(), getComputeFlopsTierProductionMultiplier() (+19 more)
...
Cohesion: 0.11
Nodes (29): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolBufferCapacity() (+21 more)

### Community 48 - "storage.js"
Cohesion: 0.08
Nodes (70): allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createInitialGameState(), eraGame(), normalizePoolMemoryCapacity(), unlockedLastTierState() (+62 more)
...
Cohesion: 0.06
Nodes (64): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), canForfeitComputeBoost(), captureFoundryUpgradeCaps(), COMPUTE_MERGE_TIMER_FIELDS (+56 more)

### Community 52 - "DevModePage/index.jsx"
Cohesion: 0.13
Nodes (17): PRESTIGE_THRESHOLD, ButtonGrid, coerceDraft(), Details, DevModePage(), FieldLabel, FieldRow, Header (+9 more)
...
Cohesion: 0.11
Nodes (18): getFlopsAutobuyerUnlockEra(), COMPUTE_FLOPS_TIER_DEFINITIONS, ERA_ELIGIBILITY_PP, TIER_DEFINITIONS, FieldNode(), FLOPS_TIER_NAME_BY_ID, isEditableScalar(), prettifySegment() (+10 more)
...
Cohesion: 0.15
Nodes (29): wouldAutobuyerStall(), buyTickspeedMultiplier(), buyTier(), buyTierQuantity(), getAutoPrestigeAttemptRate(), getCostEpochExponent(), getLastTierId(), getPrestigeProductionMultiplier() (+21 more)
...
Cohesion: 0.04
Nodes (35): clearIntroCapacityUpgradeQueue(), getAutobuyerUnlockCost(), getComputeBoostMultiplier(), getComputeBoostTierMultiplier(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getDataStreamEffectMultiplier(), getNextComputeMergeDurationUpgradeIndex() (+27 more)

### Community 66 - "App.jsx"
Cohesion: 0.29
Nodes (9): App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), loadThemePreference(), saveThemePreference(), rootElement, reportWebVitals() (+1 more)

### Community 67 - "clampNonNegative"
Cohesion: 0.21
Nodes (21): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer(), buyTickspeedAutobuyer() (+13 more)
...
Cohesion: 0.09
Nodes (51): actFoundry(), activateComputeBoost(), applyIntroProductionDoublingToIntro(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), combineIntroByte(), eraseAllComputeTokens() (+43 more)

### Community 73 - "getDataStreamBaseMultiplierPercent"
Cohesion: 0.50
...
### Community 79 - "hasFoundryAttention"
Cohesion: 0.38
...
### Community 84 - "isComputeCoreConversionUnlocked"
Cohesion: 0.70
...
### Community 97 - "getNavAttention"
Cohesion: 0.24
Nodes (10): isStorageUnlocked(), latchMainGameUnlocked(), getComputeFlopsAttentionLevel(), getNavAttention(), getStorageAttentionLevel(), getTiersAttentionLevel(), hasStorageAttention(), hasTiersAttention() (+2 more)
...
## Knowledge Gaps
- **626 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+621 more)
