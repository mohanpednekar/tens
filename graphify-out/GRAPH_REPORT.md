...
## Corpus Check
- 68 files · ~237,885 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 903 nodes · 1887 edges · 63 communities (51 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 57 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7208dab0`
...
Cohesion: 0.08
Nodes (41): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, currencyNumberFormatter, enableAutoMerge(), getAutobuyerUnlockCost(), getSmartAutobuyerCost(), isAutoMergeCloudsIntoDatacenterUnlockAvailable(), isAutoMergeClustersIntoNetworkUnlockAvailable() (+33 more)
...
Cohesion: 0.09
Nodes (26): floorToDecimals(), formatAmount(), formatBitsInNearestUnit(), formatMemoryAmount(), getMemoryUnit(), ActionsRow, BalanceText, clampPercent() (+18 more)
...
Cohesion: 0.04
Nodes (50): applyOfflineProgress(), combineIntroByte(), convertIntroBitsToKilobytes(), enableAutoClaimCore(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer (+42 more)
...
Cohesion: 0.07
Nodes (72): cliValues, defaultPPValues, simulateRun(), allResourceIds(), applyAutobuyerMilestones(), buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp() (+64 more)

### Community 48 - "StoragePage/index.jsx"
Cohesion: 0.13
Nodes (17): formatCacheSize(), formatDiskSize, getBitUnit(), getDiskSizesToShow(), DISK_ARRAY_LADDER_CAP, DISK_CACHE_BLOCK_COUNT, CacheBlock, CacheBlocksRow (+9 more)
...
Cohesion: 0.07
Nodes (28): COMPUTE_MERGE_RESERVE_CAP, ActiveBoostRow, ArmedStatusText, AutoBadge, BoostRow, canMerge(), CompactButton, COMPUTE_BOOST_DISPLAY (+20 more)
...
Cohesion: 0.17
Nodes (25): canActivateComputeBoost(), canStackComputeBoost(), getDiskBuildBaseSeconds(), getDiskBuildSeconds(), getDiskCost(), getDiskSize(), getFirstTierCost(), getIntroProductionMilestoneCost() (+17 more)
...
Cohesion: 0.23
Nodes (12): COMPUTE_CORES_PER_NODE, DEFAULT_PURCHASE_BLOCK_SIZE, TIER_DEFINITIONS, LEGACY_REMOVED_TIER_IDS, LEGACY_TIER_ID_MAP, loadGameState(), loadLastSaveTimestamp(), migrateState() (+4 more)
...
### Community 68 - "getDiskRedeemTierName"
Cohesion: 0.25
Nodes (9): getDiskRedeemTierName(), getMatchingTierForDiskSize(), getTierDiskRedeemCost(), isDiskCacheBlockReleasable(), isDiskRedeemable(), isTierAutobuyerActive(), redeemDisk(), releaseDiskCacheBlock() (+1 more)
