...
## Corpus Check
- 107 files · ~407,561 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1573 nodes · 3922 edges · 104 communities (80 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `771edee9`
...
### Community 0 - "storage.test.js"
Cohesion: 0.14
Nodes (24): PRESTIGE_UNBOUNDED_MIN_COUNT, buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage(), clearAllSaveProgress(), clearDevGameState(), clearGameState(), clearSaveSlot(), completeDummySupporterPurchase() (+16 more)
...
### Community 5 - "provisionDisk"
Cohesion: 0.14
Nodes (18): combineIntroByte(), getDataLakeCapacityUnlockArraySize(), getDataLakeSubSizeStep(), getDataLakeTierIndex(), getDiskCost(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskSize() (+10 more)
...
### Community 8 - "storage.js"
Cohesion: 0.21
Nodes (18): applyFlopsAutobuyerMilestones(), createEmptyDataLakes(), createEmptyDataLakeTier(), getFlopsAutobuyerUnlockEra(), applyPendingComputeGrants(), buildDefaultMeta(), coerceMeta(), defaultSlotName() (+10 more)
...
Cohesion: 0.13
Nodes (26): getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getPoolBufferCapacity(), getPoolEffectMultiplier(), getPoolIndexForDiskSize(), getPoolMultiplierPercent() (+18 more)
...
Cohesion: 0.22
Nodes (20): wouldAutobuyerStall(), buyTier(), buyTierQuantity(), getAutoPrestigeAttemptRate(), getCostEpochExponent(), getPrestigeProductionMultiplier(), getPurchaseBlockSize(), getPurchaseMilestoneMultiplier() (+12 more)

### Community 48 - "ComputePage"
Cohesion: 0.18
Nodes (25): actFoundry(), activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField() (+17 more)
...
Cohesion: 0.06
Nodes (34): COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_PRESETS, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED, ActiveBoostRow, ArmedStatusText, AutoBoostLabel (+26 more)

### Community 51 - "engine.js"
Cohesion: 0.05
Nodes (79): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buildEraIntroReset(), buyBooster(), buyHyperscaler(), canBuyHyperscaler(), canForfeitComputeBoost() (+71 more)
...
Cohesion: 0.10
Nodes (17): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, COMPUTE_BOOST_MAX_STACKS, COMPUTE_CORES_PER_NODE, COMPUTE_ENTITY_CAP, DATA_LAKE_CAPACITY_MAX_LEVEL (+9 more)
...
Cohesion: 0.10
Nodes (19): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, DATA_LAKE_OVERFLOW_MIN_PERCENT, DATA_LAKE_SUB_SIZE_DISK_CAPS, DISK_FILL_FROM_CACHE_BANDWIDTH_MULTIPLIER (+11 more)
...
Cohesion: 0.20
Nodes (18): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDataStreamBaseMultiplierPercent(), getDataStreamFillFraction(), getEffectiveComputeBandwidthSacrificeIndex(), getFillMultiplierPercent(), getIntroProductionMilestoneCost() (+10 more)
...
Cohesion: 0.04
Nodes (31): getComputeBoostMultiplier(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getDataStreamEffectMultiplier(), getDataStreamMultiplierPercent(), getIntroProductionRate(), getPoolCapacityUnlockThresholdBits(), getVisibleStoragePoolCount() (+23 more)
...
Cohesion: 0.12
Nodes (18): seedDataLakeSave(), allResourceIds(), createInitialGameState(), BYTES_ID, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST, INTRO_COMPUTE_CORE_UNLOCK_CAPACITY (+10 more)
...
Cohesion: 0.21
Nodes (14): App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), isComputeFlopsPageRevealed(), getNavAttention(), buildResetActiveSlotConfirmMessage(), buildResetByteFoundryConfirmMessage() (+6 more)
...
### Community 80 - "buyTickspeedMultiplier"
Cohesion: 0.48
...
Cohesion: 0.21
Nodes (18): countGlobalTickspeedMilestones(), formatAsCleanBytesIfExactMultiple(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier() (+10 more)
...
### Community 91 - "pickIntroCapacityMilestone"
Cohesion: 0.33
...
## Knowledge Gaps
- **647 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+642 more)
...
- **Should `storage.test.js` be split into smaller, more focused modules?**
