...
## Corpus Check
- 107 files · ~350,768 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1494 nodes · 3761 edges · 89 communities (65 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9221e3d1`
...
### Community 0 - "OfflineProgressNotice/index.jsx"
Cohesion: 0.33
...
Cohesion: 0.07
Nodes (29): getDiskSize(), getDiskSizesToShow(), getMaxActiveDiskLadderStep(), isDiskBuildBelowCap(), isDiskLadderExhaustedForActivePools(), ActionsRow, BalanceText, clampPercent() (+21 more)

### Community 4 - "App.jsx"
Cohesion: 0.05
Nodes (49): App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), AppMenu(), Backdrop, Icon, MenuButton (+41 more)

### Community 5 - "InfoPage/index.jsx"
Cohesion: 0.05
Nodes (49): version, ALL_TIER_IDS, formatBitsInNearestUnit(), getMemoryUnit(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER (+41 more)
...
Cohesion: 0.03
Nodes (45): enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud, enableAutoMergeGridsIntoFabric, enableAutoMergeNetworksIntoGrid, enableAutoMergeSupercomputersIntoMegacomputer (+37 more)
...
Cohesion: 0.27
Nodes (15): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroKilobyteConversionCost(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), isBandwidthAvailable() (+7 more)

### Community 48 - "useIncrementalGame.js"
Cohesion: 0.06
Nodes (94): actFoundry(), seedDataLakeSave(), activateComputeBoost(), allResourceIds(), applyFlopsAutobuyerMilestones(), applyOfflineProgress(), buildEraIntroReset(), captureFoundryUpgradeCaps() (+86 more)
...
Cohesion: 0.06
Nodes (37): canForfeitComputeBoost(), canReclaimComputeBoost(), canStartBoosterTransfer(), getDataLakeTierLabel(), getNextComputeMergeDurationUpgradeIndex(), isUpgradeComputeMergeDurationAvailable(), ActiveBoostRow, ArmedStatusText (+29 more)

### Community 51 - "isProvisionDiskAvailable"
Cohesion: 0.22
Nodes (13): canActivateComputeBoost(), canStackComputeBoost(), getDiskCost(), getPoolBufferBits(), getPoolIndexForDiskSize(), getProvisionDiskBaseSeconds(), getProvisionDiskSeconds(), isComputeBoostTurnAvailable() (+5 more)

### Community 52 - "DevModePage/index.jsx"
Cohesion: 0.06
Nodes (47): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), flooredBitsLabel(), floorToDecimals(), formatAmount(), formatBitsInNearestSiUnit(), formatComputeFlopsBoost() (+39 more)

### Community 54 - "MilestonesPage/index.jsx"
Cohesion: 0.13
Nodes (19): seedState(), derivePurchaseFieldsFromCounts(), seedMainGameState(), applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), isEraEligible() (+11 more)
...
Cohesion: 0.11
Nodes (25): ConfirmDialog(), formatAsCleanBytesIfExactMultiple(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEonsAwarded(), RESOURCE_SYMBOL() (+17 more)

### Community 58 - "isDiskFillAvailable"
Cohesion: 0.29
Nodes (11): isDiskFillAvailable(), isMemoryCapacityUpgradeAvailable(), isProvisionDiskTurnAvailable(), rewindOneIntroProductionClaim(), rollbackComputeFundedBandwidth(), tickQueuedCapacityUpgrade(), upgradePoolCapacity(), getFoundryAttentionLevel() (+3 more)
...
Cohesion: 0.16
Nodes (11): Actions, Body, Card, Overlay, Title, Body, Card, IncompatibleSaveNotice() (+3 more)
...
Cohesion: 0.17
Nodes (12): BareDivider, CapacityCell, DoubleCapacityButton, LakeGrid, LakeHeaderRow, LakeName, LakeRow, LakeStat (+4 more)

### Community 66 - "run-simulation.mjs"
Cohesion: 0.06
Nodes (90): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+82 more)
...
### Community 71 - "getDataLakeTier"
Cohesion: 0.21
Nodes (18): DataLakePanel(), getVisibleLakeTierIndexes(), createEmptyDataLakeTier(), decomposeDataLakeDeposits(), doubleDataLakeCapacity(), getBoosterPurchaseCost(), getBoosterTransferPlan(), getDataLakeAvailableUnits() (+10 more)
...
### Community 80 - "engine.js"
Cohesion: 0.06
Nodes (52): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, canStartDiskWriteCacheMerge(), clearIntroCapacityUpgradeQueue(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, decrementFullDiskCount() (+44 more)
...
Cohesion: 0.14
Nodes (30): isComputeCoreConversionUnlocked(), isComputeUpgradeTurnAvailable(), isGlobalTickspeedMultiplierUnlocked(), isStorageUnlocked(), TICKSPEED_AUTOBUYER_COST, ATTENTION_HIGH, ATTENTION_NORMAL, COMPUTE_AUTO_MERGE_UNLOCKS (+22 more)
...
Cohesion: 0.14
Nodes (22): getCoreEarnTimeSeconds(), getDiskReadCacheFlushSeconds(), getIntroProductionRate(), getNextSiDoubledValue(), getPoolBufferCapacity(), getPoolLastDiskSize(), getSiCleanCapacityBits(), getSiCleanValueAtMostBytes() (+14 more)
...
## Knowledge Gaps
- **598 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+593 more)
...
- **Should `layers.js` be split into smaller, more focused modules?**
  _Cohesion score 0.044209702660406885 - nodes in this community are weakly interconnected._