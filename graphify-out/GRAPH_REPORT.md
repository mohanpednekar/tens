# Graph Report - wt-441  (2026-08-25)

## Corpus Check
- 102 files · ~303,833 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1363 nodes · 3390 edges · 91 communities (74 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2a07de4`
...
Cohesion: 0.06
Nodes (77): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+69 more)
...
Cohesion: 0.05
Nodes (66): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, canStartDiskWriteCacheMerge(), clearIntroCapacityUpgradeQueue(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, decrementFullDiskCount(), enableAutoMerge() (+58 more)
...
Cohesion: 0.04
Nodes (55): applyOfflineProgress(), canForfeitComputeBoost(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud, enableAutoMergeGridsIntoFabric (+47 more)
...
### Community 39 - "actFoundry"
Cohesion: 0.16
Nodes (20): actFoundry(), combineIntroByte(), eraseAllComputeTokens(), getDiskCost(), getDiskLadderSizeBits(), getDiskSize(), isDiskBuildAvailable(), isDiskBuildBelowCap() (+12 more)
...
Cohesion: 0.06
Nodes (31): COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_MAX_STACKS, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow, canMerge() (+23 more)
...
Cohesion: 0.10
Nodes (24): COMPUTE_FLOPS_TIER_DEFINITIONS, INTRO_COMPUTE_CORE_UNLOCK_CAPACITY, TIER_DEFINITIONS, ButtonGrid, coerceDraft(), Details, DevModePage(), FieldLabel (+16 more)
...
Cohesion: 0.08
Nodes (67): seedDataLakeSave(), App(), allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createInitialGameState(), eraGame() (+59 more)

### Community 58 - "ConfirmDialog/index.jsx"
Cohesion: 0.15
Nodes (12): Actions, Body, Card, ConfirmDialog(), Overlay, Title, Body, Card (+4 more)

### Community 59 - "formatCurrency"
Cohesion: 0.36
...
### Community 64 - "getPrestigePointsAwarded"
Cohesion: 0.36
...
Cohesion: 0.15
Nodes (14): convertIntroBitsToKilobytes(), getDiskRedeemTierName(), getDiskSizesToShow(), getMatchingTierForDiskSize(), getRelevantDiskSizesForFoundry(), getTierDiskRedeemCost(), getTierPurchasedCount(), grantTierUnits() (+6 more)
...
Cohesion: 0.14
Nodes (13): COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED, DATA_LAKE_SLOT_MAX, EON_AMPLIFIER_AWARD_PER_LEVEL (+5 more)
...
### Community 75 - "App.test.jsx"
Cohesion: 0.10
Nodes (20): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, COMPUTE_CORES_PER_NODE, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, DISK_BUILD_COST_MULTIPLIER (+12 more)
