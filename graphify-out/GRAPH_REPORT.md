...
## Corpus Check
- 107 files · ~354,355 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1496 nodes · 3761 edges · 100 communities (75 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27e83b7c`
...
Cohesion: 0.06
Nodes (44): applyOfflineProgress(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud, enableAutoMergeGridsIntoFabric, enableAutoMergeNetworksIntoGrid (+36 more)
...
Cohesion: 0.05
Nodes (55): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_FLOPS_TIER_BY_ID (+47 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.08
Nodes (44): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getDiskSize(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims() (+36 more)
...
Cohesion: 0.08
Nodes (25): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_PRESETS, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP (+17 more)
...
Cohesion: 0.07
Nodes (38): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, enableAutoMerge(), flooredBitsLabel(), floorToDecimals() (+30 more)
...
Cohesion: 0.04
Nodes (27): clearIntroCapacityUpgradeQueue(), getAutobuyerUnlockCost(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getNextSiDoubledValue(), getSmartAutobuyerCost(), isAnyComputeMergeInFlight(), startComputeMergeReserve() (+19 more)
...
Cohesion: 0.11
Nodes (36): actTickspeed(), wouldAutobuyerStall(), buyTickspeedMultiplier(), buyTier(), buyTierQuantity(), consumeXpForLastTierTickspeed(), convertIntroBitsToKilobytes(), getAutoPrestigeAttemptRate() (+28 more)

### Community 48 - "storage.js"
Cohesion: 0.19
Nodes (29): buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage(), clearAllSaveProgress(), clearDevGameState(), clearGameState(), clearSaveSlot(), completeDummySupporterPurchase(), FREE_SLOT_COUNT (+21 more)
...
Cohesion: 0.05
Nodes (55): activateComputeBoost(), canActivateComputeBoost(), canForfeitComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), canStartBoosterTransfer(), forfeitComputeBoost(), getBiggestComputeTierWaitingOnMerge() (+47 more)

### Community 51 - "isDataLakeCapacityDoublingTurnAvailable"
Cohesion: 0.25
Nodes (9): getDataLakeAvailableUnits(), getPoolLastDiskSize(), isAnyDataLakeCapacityDoublingAvailable(), isDataLakeCapacityDoublingAvailable(), isDataLakeCapacityDoublingTurnAvailable(), isIdleDiskLiquidationAvailable(), isIdleDiskLiquidationTurnAvailable(), liquidateIdleDisk() (+1 more)

### Community 52 - "ComputeFlopsPage/index.jsx"
Cohesion: 0.14
Nodes (19): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), formatComputeFlopsBoost(), formatComputeFlopsTotal(), getComputeFlopsTierCost(), getComputeFlopsTierProductionMultiplier(), getHyperscalerFlopsBoostRate() (+11 more)

### Community 53 - "App.test.jsx"
Cohesion: 0.07
Nodes (23): version, ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_CORES_PER_NODE (+15 more)

### Community 54 - "MilestonesPage/index.jsx"
Cohesion: 0.14
Nodes (17): applyFlopsAutobuyerMilestones(), buildEraIntroReset(), eraGame(), getEonsAwarded(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), isEraEligible(), Badge (+9 more)
...
Cohesion: 0.17
Nodes (15): actFoundry(), combineIntroByte(), eraseAllComputeTokens(), isDiskBuildBelowCap(), isInvestProgressBelowCap(), isMemoryCapacityAtCap(), isMemoryCapacityUpgradeAvailable(), isPoolCapacityUpgradeAvailable() (+7 more)
...
Cohesion: 0.14
Nodes (28): checkMilestones(), countGlobalTickspeedMilestones(), formatAmount(), formatAsCleanBytesIfExactMultiple(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific() (+20 more)
...
Cohesion: 0.10
Nodes (29): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+21 more)
...
### Community 70 - "applyDevGameStateJson"
Cohesion: 0.18
Nodes (13): createEmptyDataLakes(), createEmptyDataLakeTier(), normalizePoolMemoryCapacity(), applyDevGameStateJson(), isPlainObject(), loadGameState(), mergeDataLakes(), mergeState() (+5 more)

### Community 71 - "DataLakePanel/index.jsx"
Cohesion: 0.11
Nodes (39): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeGrid, LakeHeaderRow, LakeName (+31 more)
...
### Community 73 - "save-migration/index.js"
Cohesion: 0.36
...
Cohesion: 0.22
Nodes (8): APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar, Icon, Label, NavItem, pulseHigh
...
### Community 84 - "defaultSlotName"
Cohesion: 0.83
Nodes (4): buildDefaultMeta(), coerceMeta(), defaultSlotName(), withSupporterSlots()

### Community 85 - "navAttention.js"
Cohesion: 0.09
Nodes (46): buyGlobalTickspeedMultiplier(), getGlobalTickspeedMultiplierCost(), isComputeCloudsMergeStartAvailable(), isComputeClustersMergeStartAvailable(), isComputeCoreConversionUnlocked(), isComputeCoresMergeStartAvailable(), isComputeDatacentersMergeStartAvailable(), isComputeFabricsMergeStartAvailable() (+38 more)
...
### Community 96 - "resetByteFoundry"
Cohesion: 1.00
Nodes (3): captureFoundryUpgradeCaps(), mergeFoundryUpgradeCaps(), resetByteFoundry()

### Community 97 - "getStoragePoolBandwidth"
Cohesion: 0.15
Nodes (22): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getNextDiskLadderSize(), getPoolBufferCapacity() (+14 more)
...
## Knowledge Gaps
- **601 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+596 more)
