...
## Corpus Check
- 107 files · ~355,969 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1498 nodes · 3760 edges · 110 communities (81 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cf7d68db`
...
Cohesion: 0.06
Nodes (51): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_FLOPS_TIER_BY_ID, COMPUTE_FLOPS_TIER_INDEX_BY_ID (+43 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.07
Nodes (42): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getDiskSize(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims() (+34 more)
...
Cohesion: 0.09
Nodes (27): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, flooredBitsLabel(), floorToDecimals(), formatBitsInNearestSiUnit() (+19 more)
...
Cohesion: 0.05
Nodes (9): clearIntroCapacityUpgradeQueue(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostMultiplier(), getNextSiDoubledValue(), isAnyComputeMergeInFlight(), noOtherUpgradesLeft, unlockedLastTierState(), withOwned() (+1 more)
...
Cohesion: 0.20
Nodes (26): clearAllSaveProgress(), clearDevGameState(), clearGameState(), clearSaveSlot(), completeDummySupporterPurchase(), discardIncompatibleActiveSaveIfNeeded(), FREE_SLOT_COUNT, getActiveSlotId() (+18 more)
...
Cohesion: 0.06
Nodes (31): getNextComputeMergeDurationUpgradeIndex(), ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow, canMerge(), CompactButton (+23 more)

### Community 51 - "getUnlockedStoragePoolCount"
Cohesion: 0.19
Nodes (13): getPoolCapacityUnlockThresholdBits(), getPoolLastDiskSize(), getStoragePoolCount(), getUnlockedStoragePoolCount(), getVisibleStoragePoolCount(), isIdleDiskLiquidationAvailable(), isIdleDiskLiquidationTurnAvailable(), isMemoryCapacityAtCap() (+5 more)
...
Cohesion: 0.12
Nodes (15): Body, Card, IncompatibleSaveNotice(), Overlay, Title, StatCard, Badge, Category (+7 more)
...
Cohesion: 0.09
Nodes (26): applyFlopsAutobuyerMilestones(), buildEraIntroReset(), eraGame(), getEonsAwarded(), getFlopsAutobuyerUnlockEra(), isEraEligible(), buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage() (+18 more)

### Community 58 - "ComputePage"
Cohesion: 0.22
Nodes (22): activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), getComputeBoostTierMultiplier(), isBandwidthAvailable() (+14 more)
...
### Community 62 - "ConfirmDialog/index.jsx"
Cohesion: 0.29
...
Cohesion: 0.11
Nodes (25): actFoundry(), actMainBuys(), actPlayer(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+17 more)
...
Cohesion: 0.12
Nodes (17): AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_FIRST_TIER_COST_PP, COMPUTE_FLOPS_REVEAL_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST (+9 more)
...
Cohesion: 0.09
Nodes (44): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeGrid, LakeHeaderRow, LakeName (+36 more)
...
Cohesion: 0.06
Nodes (55): APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar, Icon, Label, NavItem, pulseHigh (+47 more)

### Community 86 - "createInitialGameState"
Cohesion: 0.29
Nodes (8): seedDataLakeSave(), allResourceIds(), captureFoundryUpgradeCaps(), createInitialGameState(), mergeFoundryUpgradeCaps(), prestigeGame(), resetByteFoundry(), withIntro()
...
### Community 96 - "getOverclockRequirement"
Cohesion: 0.60
...
### Community 107 - "TIER_DEFINITIONS"
Cohesion: 0.40
