...
## Corpus Check
- 107 files · ~378,910 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1545 nodes · 3912 edges · 102 communities (78 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27b38b94`
...
Cohesion: 0.06
Nodes (51): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), captureFoundryUpgradeCaps(), clearIntroCapacityUpgradeQueue(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter (+43 more)
...
Cohesion: 0.07
Nodes (34): DATA_LAKE_OVERFLOW_MAX_PERCENT, DATA_LAKE_OVERFLOW_MIN_PERCENT, ActionsRow, BalanceText, clampGaugeValue(), DataStreamCard, FillableStatCard, fractionToBottomAngle() (+26 more)
...
Cohesion: 0.10
Nodes (20): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_CORES_PER_NODE, COMPUTE_ENTITY_CAP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED (+12 more)
...
Cohesion: 0.08
Nodes (36): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+28 more)
...
Cohesion: 0.18
Nodes (17): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDataLakeSubSize(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds() (+9 more)

### Community 48 - "storage.js"
Cohesion: 0.09
Nodes (58): applyFlopsAutobuyerMilestones(), createEmptyDataLakes(), createEmptyDataLakeTier(), PRESTIGE_UNBOUNDED_MIN_COUNT, applyDevGameStateJson(), buildClearSlotConfirmMessage(), buildDefaultMeta(), buildEraseAllSavesConfirmMessage() (+50 more)
...
Cohesion: 0.06
Nodes (34): getNextComputeMergeDurationUpgradeIndex(), COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_MAX_STACKS, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, ActiveBoostRow, ArmedStatusText, AutoBoostLabel (+26 more)

### Community 51 - "engine.test.js"
Cohesion: 0.04
Nodes (67): applyOfflineProgress(), buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer() (+59 more)
...
Cohesion: 0.09
Nodes (18): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_MERGE_RATIO, DATA_LAKE_CAPACITY_MAX_LEVEL, DEFAULT_PURCHASE_BLOCK_SIZE (+10 more)

### Community 54 - "MilestonesPage/index.jsx"
Cohesion: 0.16
Nodes (13): getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), ERA_ELIGIBILITY_PP, Badge, Category, CategoryHeading, Header, List (+5 more)
...
Cohesion: 0.10
Nodes (25): buildEraIntroReset(), eraGame(), formatAsCleanBytesIfExactMultiple(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEonsAwarded(), isEraEligible() (+17 more)

### Community 58 - "clampNonNegative"
Cohesion: 0.17
Nodes (28): wouldAutobuyerStall(), buyTier(), buyTierQuantity(), checkMilestones(), clampNonNegative(), getAutoPrestigeAttemptRate(), getComputeFlopsTierProductionMultiplier(), getCostEpochExponent() (+20 more)
...
Cohesion: 0.11
Nodes (30): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, manualPulse (+22 more)
...
Cohesion: 0.16
Nodes (20): countGlobalTickspeedMilestones(), formatBytes(), getAutoPrestigeCost(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getNextBytePowerProgressFraction(), getOverclockMultiplier() (+12 more)

### Community 65 - "getDiskSizesToShow"
Cohesion: 0.40
Nodes (5): getDiskSizesToShow(), Header, RootDiv, StoragePage(), Title

### Community 66 - "navAttention.test.js"
Cohesion: 0.22
Nodes (16): buyGlobalTickspeedMultiplier(), getGlobalTickspeedMultiplierCost(), isGlobalTickspeedMultiplierUnlocked(), isProductionFrozen(), TICKSPEED_AUTOBUYER_COST, ATTENTION_NORMAL, getTiersAttentionLevel(), hasAffordableFullLevel() (+8 more)
...
Cohesion: 0.13
Nodes (23): getDataLakeOverflowRatePercent(), getDataStreamBaseMultiplierPercent(), getDataStreamFillFraction(), getDecadePowerEquivalentBits(), getFillMultiplierPercent(), getPoolBaseMultiplierPercent(), getPoolBufferCapacity(), getPoolBufferFillFraction() (+15 more)
...
### Community 75 - "getNavAttention"
Cohesion: 0.29
Nodes (8): isStorageUnlocked(), getComputeFlopsAttentionLevel(), getNavAttention(), getStorageAttentionLevel(), hasAffordableComputeFlopsTier(), hasStorageAttention(), maxAttention(), pickLevel()
...
### Community 84 - "AppMenu/index.jsx"
Cohesion: 0.29
...
### Community 87 - "ByteFoundryPage"
Cohesion: 0.13
Nodes (37): activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), getComputeBoostTierMultiplier() (+29 more)
...
### Community 90 - "isComputeCoreConversionUnlocked"
Cohesion: 0.70
...
Cohesion: 0.12
Nodes (19): actFoundry(), combineIntroByte(), convertIntroBitsToKilobytes(), eraseAllComputeTokens(), getComputeBoostMultiplier(), getDataStreamEffectMultiplier(), getDataStreamMultiplierPercent(), getPoolCapacityUnlockThresholdBits() (+11 more)
