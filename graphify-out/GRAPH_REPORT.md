...
## Corpus Check
- 108 files · ~328,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1460 nodes · 3673 edges · 103 communities (84 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `087053c7`
...
Cohesion: 0.05
Nodes (64): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTO_SPEED_UP_COST, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP (+56 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.09
Nodes (25): floorToDecimals(), formatBitsInNearestUnit(), formatMemoryAmount(), getMemoryUnit(), ActionsRow, BalanceText, DataStreamCard, Divider (+17 more)
...
Cohesion: 0.04
Nodes (35): clearIntroCapacityUpgradeQueue(), enableAutoMerge(), getAutobuyerUnlockCost(), getTickspeedMultiplierBaseCost(), getTierProductionProgressPercent(), isAnyComputeMergeInFlight(), isAutoMergeCloudsIntoDatacenterUnlockAvailable(), isAutoMergeClustersIntoNetworkUnlockAvailable() (+27 more)
...
Cohesion: 0.29
Nodes (14): wouldAutobuyerStall(), buyTier(), buyTierQuantity(), getCostEpochExponent(), getPurchaseBlockSize(), getTierAffordableQuantity(), getTierBulkQuantity(), getTierCost() (+6 more)
...
Cohesion: 0.05
Nodes (58): actFoundry(), activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), canStartBoosterTransfer(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostMultiplier() (+50 more)

### Community 51 - "MilestonesPage/index.jsx"
Cohesion: 0.15
Nodes (16): OfflineProgressNotice(), formatOfflineDuration(), getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), InfoPage(), Badge, Category (+8 more)
...
### Community 54 - "getUnlockedStoragePoolCount"
Cohesion: 0.24
Nodes (10): eraseAllComputeTokens(), getStoragePoolCount(), getUnlockedStoragePoolCount(), isMemoryCapacityUpgradeAvailable(), isStoragePoolUnlocked(), pickIntroCapacityMilestone(), rewindOneIntroProductionClaim(), rollbackComputeFundedBandwidth() (+2 more)
...
Cohesion: 0.17
Nodes (26): buyGlobalTickspeedMultiplier(), getGlobalTickspeedMultiplierCost(), getSmartAutobuyerCost(), isComputeFlopsPageRevealed(), isGlobalTickspeedMultiplierUnlocked(), isProductionFrozen(), isTierUnlocked(), ATTENTION_NORMAL (+18 more)
...
Cohesion: 0.15
Nodes (13): scripts, audit, build, build:capacitor, build:staging, bump-version, cap:sync, dev (+5 more)
...
### Community 62 - "isProvisionDiskAvailable"
Cohesion: 0.24
Nodes (11): combineIntroByte(), getDiskCost(), getDiskSize(), getMaxActiveDiskLadderStep(), getProvisionDiskSeconds(), isDiskBuildBelowCap(), isDiskLadderExhaustedForActivePools(), isInvestProgressBelowCap() (+3 more)
...
Cohesion: 0.06
Nodes (34): version, ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, BYTES_ID, COMPUTE_BOOST_MAX_STACKS (+26 more)

### Community 65 - "DataLakePanel/index.jsx"
Cohesion: 0.10
Nodes (42): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeGrid, LakeHeaderRow, LakeName (+34 more)

### Community 66 - "clampNonNegative"
Cohesion: 0.16
Nodes (28): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyComputeFlopsTier(), buyHyperscaler(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus() (+20 more)
...
### Community 68 - "createInitialGameState"
Cohesion: 0.33
...
### Community 71 - "tickComputeMergeBoundary"
Cohesion: 0.14
...
Cohesion: 0.33
Nodes (12): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), isBandwidthAvailable(), isBitFundedBandwidthAvailable() (+4 more)

### Community 73 - "InfoPage/index.jsx"
Cohesion: 0.09
Nodes (22): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP (+14 more)
...
### Community 77 - "save-migration/index.js"
Cohesion: 0.36
...
Cohesion: 0.06
Nodes (57): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, canForfeitComputeBoost(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, enableAutoMergeCloudsIntoDatacenter (+49 more)

### Community 80 - "getStoragePoolBandwidth"
Cohesion: 0.26
Nodes (12): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolIndexForDiskSize(), getProvisionDiskBaseSeconds() (+4 more)
...
Cohesion: 0.36
Nodes (9): isBandwidthTurnAvailable(), isDiskFillAvailable(), isProvisionDiskTurnAvailable(), isStorageUnlocked(), getFoundryAttentionLevel(), hasFoundryAttention(), hasStorageAttention(), isCombineAvailable() (+1 more)
...
### Community 86 - "getPrestigePointsAwarded"
Cohesion: 0.36
...
### Community 97 - "getStoragePoolMemoryBounds"
Cohesion: 0.40
Nodes (5): getStoragePoolCapacity(), isMemoryCapacityAtCap(), isPoolCapacityUpgradeAvailable(), queueIntroCapacityUpgrade(), getStoragePoolMemoryBounds()

### Community 99 - "getIntroKilobyteConversionCost"
Cohesion: 0.50
Nodes (4): convertIntroBitsToKilobytes(), getIntroKilobyteConversionCost(), isIntroConversionUnlocked(), isTransferBlockAffordable()

## Knowledge Gaps
- **580 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+575 more)
