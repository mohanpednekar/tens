...
## Corpus Check
- 107 files · ~401,864 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1578 nodes · 3988 edges · 102 communities (77 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0f0ddd71`
...
Cohesion: 0.05
Nodes (94): App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), AppMenu(), Backdrop, Icon, MenuButton (+86 more)
...
Cohesion: 0.10
Nodes (19): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER, DATA_LAKE_OVERFLOW_MIN_PERCENT (+11 more)
...
Cohesion: 0.25
Nodes (18): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer(), buyTickspeedAutobuyer() (+10 more)
...
Cohesion: 0.20
Nodes (18): buyTier(), buyTierQuantity(), getCostEpochExponent(), getPurchaseBlockSize(), getTierCost(), getTierPurchasedCount(), getTierQuantityCost(), getTierSpendableAmount() (+10 more)

### Community 48 - "ByteFoundryPage"
Cohesion: 0.25
Nodes (14): applyIntroProductionDoublingToIntro(), formatBitsInNearestUnit(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), getMemoryUnit() (+6 more)
...
Cohesion: 0.06
Nodes (33): getNextComputeMergeDurationUpgradeIndex(), COMPUTE_ENTITY_CAP, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow (+25 more)
...
Cohesion: 0.10
Nodes (16): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, COMPUTE_BOOST_MAX_STACKS, COMPUTE_CORES_PER_NODE, DATA_LAKE_CAPACITY_MAX_LEVEL, DATA_LAKE_OVERFLOW_MAX_PERCENT (+8 more)
...
Cohesion: 0.21
Nodes (12): actFoundry(), combineIntroByte(), convertIntroBitsToKilobytes(), getVisibleStoragePoolCount(), isDiskBuildBelowCap(), isInvestProgressBelowCap(), latchMainGameUnlocked(), pickIntroCapacityMilestone() (+4 more)
...
Cohesion: 0.04
Nodes (33): clearIntroCapacityUpgradeQueue(), enableAutoMerge(), eraseAllComputeTokens(), getNextSiDoubledValue(), getPoolCapacityUnlockThresholdBits(), isAnyComputeMergeInFlight(), isAutoMergeCloudsIntoDatacenterUnlockAvailable(), isAutoMergeClustersIntoNetworkUnlockAvailable() (+25 more)

### Community 66 - "getStoragePoolBandwidth"
Cohesion: 0.12
Nodes (29): getDecadePowerEquivalentBits(), getDiskCost(), getDiskLadderSizeBits(), getDiskReadCacheFlushSeconds(), getDiskSize(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate() (+21 more)

### Community 67 - "navAttention.js"
Cohesion: 0.16
Nodes (26): getDiskSizesToShow(), getIntroKilobyteConversionCost(), isComputeCoreConversionUnlocked(), isComputeUpgradeTurnAvailable(), isIntroConversionUnlocked(), isStorageUnlocked(), COMPUTE_AUTO_MERGE_UNLOCKS, COMPUTE_INSTANT_MERGE_BOUNDARIES (+18 more)

### Community 68 - "navAttention.test.js"
Cohesion: 0.12
Nodes (15): AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_FLOPS_REVEAL_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST, INTRO_CONVERSION_UNLOCK_CAPACITY, INTRO_DISK_UNLOCK_CAPACITY (+7 more)
...
### Community 72 - "tickDiskWriteCache"
Cohesion: 0.16
Nodes (15): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDataLakeSubSize(), getDataLakeTierIndex(), getDiskLadderStep(), getDiskRequiredTierLevel(), getIdleDiskLiquidationSizes(), getNextDiskLadderSize() (+7 more)
...
Cohesion: 0.36
Nodes (14): canActivateComputeBoost(), canStackComputeBoost(), isBandwidthAvailable(), isBandwidthTurnAvailable(), isComputeBoostTurnAvailable(), isComputeUpgradeAvailable(), isDataLakeCapacityDoublingTurnAvailable(), isDiskFillAvailable() (+6 more)
...
Cohesion: 0.12
Nodes (16): Architecture / MainPage UI decisions, Byte Foundry gate made permanent, one-time-ever; fill-multiplier instant loss beyond 200%; gauge relocated inside the tile — 2026-09-02, CLAUDE.md Economy model duplication trim — 2026-09-03, Data Lake unlock/capacity tied to real Storage progress; giant-circle CSS bug; Compute Boost reclaim floor — 2026-09-03, Data Stream / Buffer rename; Capacity Sacrifice removed (#506; superseded by #456) — 2026-08-27, Design history & rationale, Distribution, Documentation (+8 more)
...
### Community 80 - "activateComputeBoost"
Cohesion: 0.31
Nodes (10): activateComputeBoost(), canReclaimComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), getComputeBoostTierMultiplier(), isValidComputeBoostTier(), reclaimComputeBoost() (+2 more)
...
Cohesion: 0.29
Nodes (7): flooredBitsLabel(), floorToDecimals(), formatBitsInNearestSiUnit(), formatCacheSize(), formatMemoryAmount(), getBitUnit(), getSiByteUnit()
...
## Knowledge Gaps
- **637 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+632 more)
