...
## Corpus Check
- 107 files · ~347,461 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1490 nodes · 3756 edges · 108 communities (80 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f585e7cd`
...
Cohesion: 0.15
Nodes (18): buyTickspeedMultiplier(), getAutoPrestigeAttemptRate(), getComputeBoostMultiplier(), getEffectiveTierTickSpeedSeconds(), getLastTierId(), getLastTierXpTickspeedMultiplier(), getPrestigeProductionMultiplier(), getPurchaseMilestoneMultiplier() (+10 more)
...
Cohesion: 0.06
Nodes (50): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_MILESTONE_START, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_FLOPS_TIER_BY_ID, COMPUTE_FLOPS_TIER_DEFINITIONS (+42 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.08
Nodes (23): ActionsRow, BalanceText, DataStreamCard, Divider, FillableStatCard, Header, MilestoneButtonContent, MilestoneCostLine (+15 more)
...
Cohesion: 0.09
Nodes (22): version, CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP (+14 more)
...
Cohesion: 0.13
Nodes (19): actFoundry(), combineIntroByte(), convertIntroBitsToKilobytes(), eraseAllComputeTokens(), getIntroKilobyteConversionCost(), getNextSiDoubledValue(), isDiskBuildBelowCap(), isInvestProgressBelowCap() (+11 more)
...
Cohesion: 0.12
Nodes (25): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+17 more)
...
Cohesion: 0.11
Nodes (26): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), flooredBitsLabel(), floorToDecimals(), formatAmount(), formatComputeFlopsBoost(), formatComputeFlopsTotal() (+18 more)

### Community 70 - "engine.js"
Cohesion: 0.08
Nodes (27): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, formatBitsInNearestSiUnit(), formatBitsInNearestUnit(), getMemoryUnit() (+19 more)
...
Cohesion: 0.22
Nodes (14): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolIndexForDiskSize(), getProvisionDiskBaseSeconds() (+6 more)
...
### Community 103 - "isDiskFillAvailable"
Cohesion: 0.47
Nodes (6): getDiskSizesToShow(), isDiskFillAvailable(), isStorageUnlocked(), getStorageAttentionLevel(), hasStorageAttention(), StoragePage()

### Community 104 - "MainPage"
Cohesion: 0.15
Nodes (23): buyGlobalTickspeedMultiplier(), countGlobalTickspeedMilestones(), formatAsCleanBytesIfExactMultiple(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getGlobalTickspeedMultiplierCost() (+15 more)

## Knowledge Gaps
- **596 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+591 more)
