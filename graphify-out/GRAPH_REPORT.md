...
## Corpus Check
- 107 files · ~326,850 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1456 nodes · 3673 edges · 104 communities (85 shown, 19 thin omitted)
...
Cohesion: 0.06
Nodes (68): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, MEMORY_BINARY_UNIT_SYMBOLS, plainNumberFormatter, scientificNumberFormatter (+60 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.09
Nodes (22): isIntroConversionUnlocked(), isTransferBlockAffordable(), ActionsRow, BalanceText, DataStreamCard, Divider, FillableStatCard, Header (+14 more)
...
Cohesion: 0.15
Nodes (21): actTickspeed(), buyGlobalTickspeedMultiplier(), buyTickspeedMultiplier(), consumeXpForLastTierTickspeed(), getAutoPrestigeAttemptRate(), getGlobalTickspeedMultiplierCost(), getLastTierId(), getLastTierXpTickspeedMinConsumption() (+13 more)
...
Cohesion: 0.05
Nodes (14): canForfeitComputeBoost(), clearIntroCapacityUpgradeQueue(), forfeitComputeBoost(), isAnyComputeMergeInFlight(), isUpgradeComputeMergeDurationAvailable(), releaseDiskCacheBlock(), eraEligibleState(), noOtherUpgradesLeft (+6 more)
...
Cohesion: 0.18
Nodes (21): wouldAutobuyerStall(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getCostEpochExponent(), getIntroKilobyteConversionCost(), getTierAffordableQuantity(), getTierBulkQuantity() (+13 more)
...
Cohesion: 0.07
Nodes (33): getDataLakeAvailableUnits(), getNextComputeMergeDurationUpgradeIndex(), ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow, canMerge() (+25 more)
...
Cohesion: 0.06
Nodes (81): seedDataLakeSave(), App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), AppMenu(), Backdrop, Icon (+73 more)

### Community 54 - "activateComputeBoost"
Cohesion: 0.18
...
Cohesion: 0.33
Nodes (7): combineIntroByte(), getDiskCost(), getDiskSize(), isDiskBuildBelowCap(), isInvestProgressBelowCap(), provisionDisk(), tickFoundryResetConvenience()
...
Cohesion: 0.16
Nodes (19): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, LakeGrid, LakeHeaderRow, LakeName, LakeRow (+11 more)
...
### Community 67 - "navAttention.test.js"
Cohesion: 0.12
...
### Community 71 - "formatAmount"
Cohesion: 0.23
Nodes (16): buyComputeFlopsTier(), canBuyComputeFlopsTier(), formatAmount(), formatBytes(), formatComputeFlopsBoost(), formatComputeFlopsTotal(), formatCurrency(), formatMoneyBalance() (+8 more)

### Community 72 - "prestigeGame"
Cohesion: 0.15
Nodes (15): seedState(), applyAutobuyerMilestones(), floorToDecimals(), formatBitsInNearestSiUnit(), formatBitsInNearestUnit(), formatMemoryAmount(), getAutobuyerUnlockMilestone(), getMemoryUnit() (+7 more)

### Community 73 - "InfoPage/index.jsx"
Cohesion: 0.09
Nodes (21): version, CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP (+13 more)
...
### Community 77 - "getDataLakeTier"
Cohesion: 0.29
Nodes (12): getVisibleLakeTierIndexes(), canStartBoosterTransfer(), decomposeDataLakeDeposits(), doubleDataLakeCapacity(), getBoosterPurchaseCost(), getBoosterTransferPlan(), getDataLakeCapacityLevel(), getDataLakeDepositedUnits() (+4 more)
...
### Community 80 - "getDiskLadderSizeBits"
Cohesion: 0.20
Nodes (15): canDepositDiskToDataLake(), canStartDiskWriteCacheMerge(), decrementFullDiskCount(), depositDiskToDataLake(), getDataLakeSubSize(), getDataLakeSubSizeStep(), getDataLakeTierIndex(), getDataLakeTransferCapacity() (+7 more)
...
### Community 84 - "isDiskFillAvailable"
Cohesion: 0.38
Nodes (11): isBandwidthAvailable(), isBandwidthTurnAvailable(), isComputeBoostTurnAvailable(), isDiskFillAvailable(), isMemoryCapacityUpgradeAvailable(), isProvisionDiskAvailable(), isProvisionDiskTurnAvailable(), getFoundryAttentionLevel() (+3 more)

### Community 85 - "MainPage"
Cohesion: 0.17
Nodes (19): checkMilestones(), countGlobalTickspeedMilestones(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getMoneyExponent(), getNextBytePowerProgressFraction(), getOverclockMultiplier() (+11 more)

### Community 86 - "actFoundry"
Cohesion: 0.29
Nodes (8): actFoundry(), eraseAllComputeTokens(), pickIntroCapacityMilestone(), rewindOneIntroProductionClaim(), rollbackComputeFundedBandwidth(), setAutobuyerEnabled(), tickQueuedCapacityUpgrade(), upgradePoolCapacity()
...
Cohesion: 0.43
Nodes (8): getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getPoolIndexForDiskSize(), getProvisionDiskBaseSeconds(), getProvisionDiskSeconds(), getStoragePoolBandwidth(), tickDiskAutoFill()

### Community 99 - "getUnlockedStoragePoolCount"
Cohesion: 0.29
Nodes (8): getMaxActiveDiskLadderStep(), getStoragePoolCount(), getUnlockedStoragePoolCount(), isDiskLadderExhaustedForActivePools(), isMemoryCapacityAtCap(), isPoolCapacityUpgradeAvailable(), isStoragePoolUnlocked(), queueIntroCapacityUpgrade()

### Community 100 - "OfflineProgressNotice/index.jsx"
Cohesion: 0.33
Nodes (6): VisuallyHidden, NoticeText, OfflineNoticeCard, OfflineNoticeOverlay, OfflineProgressNotice(), formatOfflineDuration()

### Community 102 - "applyOfflineProgress"
Cohesion: 1.00
Nodes (3): applyOfflineProgress(), getOfflineEffectiveSeconds(), computeOfflineCatchUp()

## Knowledge Gaps
- **577 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+572 more)
