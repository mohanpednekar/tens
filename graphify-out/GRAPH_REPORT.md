...
## Corpus Check
- 107 files · ~347,704 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1490 nodes · 3755 edges · 108 communities (81 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bfbc2ff7`
...
### Community 0 - "tickGame"
Cohesion: 0.24
Nodes (14): actTickspeed(), buyTickspeedMultiplier(), consumeXpForLastTierTickspeed(), getAutoPrestigeAttemptRate(), getLastTierId(), getLastTierXpTickspeedMinConsumption(), getPrestigeProductionMultiplier(), getPurchaseBlockSize() (+6 more)
...
Cohesion: 0.06
Nodes (53): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTO_SPEED_UP_COST, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP (+45 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.08
Nodes (24): ActionsRow, BalanceText, clampPercent(), DataStreamCard, Divider, FillableStatCard, Header, MilestoneButtonContent (+16 more)
...
Cohesion: 0.08
Nodes (28): applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getTierTickspeedAutobuyerMilestone(), CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_MAX_STACKS, COMPUTE_BOOST_TIER_POWER_STEP (+20 more)
...
### Community 8 - "buyTierQuantity"
Cohesion: 0.16
Nodes (23): wouldAutobuyerStall(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getCostEpochExponent(), getIntroKilobyteConversionCost(), getTierAffordableQuantity(), getTierBulkQuantity() (+15 more)
...
Cohesion: 0.05
Nodes (13): clearIntroCapacityUpgradeQueue(), getAutobuyerUnlockCost(), getComputeBoostMultiplier(), getComputeBoostTierMultiplier(), getTickspeedMultiplierBaseCost(), getTierProductionProgressPercent(), isAnyComputeMergeInFlight(), noOtherUpgradesLeft (+5 more)
...
Cohesion: 0.36
Nodes (12): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), isBandwidthAvailable(), isBandwidthTurnAvailable() (+4 more)

### Community 48 - "useIncrementalGame"
Cohesion: 0.06
Nodes (82): seedDataLakeSave(), App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), AppMenu(), Backdrop, Icon (+74 more)
...
Cohesion: 0.22
Nodes (15): activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), isComputeBoostTurnAvailable() (+7 more)
...
### Community 53 - "getPrestigePointsAwarded"
Cohesion: 0.36
...
Cohesion: 0.15
Nodes (17): actFoundry(), combineIntroByte(), eraseAllComputeTokens(), isDiskBuildBelowCap(), isInvestProgressBelowCap(), isMemoryCapacityAtCap(), isMemoryCapacityUpgradeAvailable(), isPoolCapacityUpgradeAvailable() (+9 more)
...
### Community 64 - "navAttention.test.js"
Cohesion: 0.12
...
### Community 67 - "useIncrementalGame.js"
Cohesion: 0.05
...
Cohesion: 0.25
Nodes (11): decomposeDataLakeDeposits(), getDataLakeSubSizeStep(), getDataLakeTransferDurationSeconds(), getDataLakeUnitBits(), getDiskLadderSizeBits(), getDiskLadderStep(), getNextDiskLadderSize(), latchComputeMergePageIfNeeded() (+3 more)

### Community 69 - "ComputeFlopsPage/index.jsx"
Cohesion: 0.18
Nodes (10): Money, FlopsHero, Header, Hint, RootDiv, TierList, TierMeta, TierName (+2 more)

### Community 70 - "engine.js"
Cohesion: 0.08
Nodes (29): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, flooredBitsLabel(), floorToDecimals(), formatBitsInNearestSiUnit() (+21 more)

### Community 71 - "ComputePage"
Cohesion: 0.28
Nodes (9): canStartBoosterTransfer(), getBoosterPurchaseCost(), getBoosterTransferPlan(), getDataLakeTransferCapacity(), getNextComputeMergeDurationUpgradeIndex(), isDiskArrayFullyBuilt(), canMerge(), ComputePage() (+1 more)
...
### Community 80 - "tickComputeMergeBoundary"
Cohesion: 0.14
...
### Community 84 - "applyOfflineProgress"
Cohesion: 1.00
...
### Community 86 - "getStoragePoolBandwidth"
Cohesion: 0.24
Nodes (13): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolIndexForDiskSize(), getProvisionDiskBaseSeconds() (+5 more)

### Community 87 - "clampNonNegative"
Cohesion: 0.15
Nodes (32): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyComputeFlopsTier(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer() (+24 more)
...
### Community 90 - "isProvisionDiskAvailable"
Cohesion: 0.39
Nodes (8): getDiskCost(), getDiskSize(), getMaxActiveDiskLadderStep(), getPoolBufferBits(), isDiskLadderExhaustedForActivePools(), isProvisionDiskAvailable(), isProvisionDiskTurnAvailable(), provisionDisk()

### Community 91 - "buyGlobalTickspeedMultiplier"
Cohesion: 0.67
...
Cohesion: 0.31
Nodes (9): getPoolLastDiskSize(), getStoragePoolCount(), getUnlockedStoragePoolCount(), isAnyDataLakeCapacityDoublingAvailable(), isIdleDiskLiquidationAvailable(), isIdleDiskLiquidationTurnAvailable(), isStoragePoolUnlocked(), liquidateIdleDisk() (+1 more)
...
### Community 103 - "canDepositDiskToDataLake"
Cohesion: 0.83
Nodes (4): canDepositDiskToDataLake(), depositDiskToDataLake(), getDataLakeTierIndex(), tickDiskAutoDeposit()

### Community 104 - "MainPage"
Cohesion: 0.24
Nodes (16): countGlobalTickspeedMilestones(), formatAsCleanBytesIfExactMultiple(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier() (+8 more)

### Community 105 - "buyHyperscaler"
Cohesion: 1.00
Nodes (3): buyHyperscaler(), canBuyHyperscaler(), getHyperscalerEonCost()

## Knowledge Gaps
- **597 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+592 more)
