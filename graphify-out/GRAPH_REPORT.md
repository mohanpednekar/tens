...
## Corpus Check
- 66 files · ~179,385 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 730 nodes · 1354 edges · 52 communities (39 shown, 13 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8d50e8e2`
...
Cohesion: 0.05
Nodes (62): cliValues, defaultPPValues, simulateRun(), buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyGlobalTickspeedMultiplier(), buyPrestigeSpeedBonus(), buySmartAutobuyer() (+54 more)
...
Cohesion: 0.12
Nodes (34): allResourceIds(), applyAutobuyerMilestones(), applyOfflineProgress(), buildStorageBank(), buyAutoSpeedUp(), buyTickspeedAutobuyer(), combineIntroByte(), convertIntroBitsToKilobytes() (+26 more)
...
Cohesion: 0.06
Nodes (48): formatAmount(), formatCurrency(), formatScientific(), getFirstTierCost(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), getIntroProductionRate(), getStorageBankCost() (+40 more)
...
## Knowledge Gaps
- **360 isolated node(s):** `session-start.sh script`, `defaultPPValues`, `cliValues`, `seededState`, `baseUrl` (+355 more)
