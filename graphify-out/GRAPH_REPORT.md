...
## Corpus Check
- 108 files · ~453,777 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1626 nodes · 4042 edges · 105 communities (83 shown, 19 thin omitted)
...
Cohesion: 0.08
Nodes (44): enableAutoMerge(), getIntroKilobyteConversionCost(), getOverclockRequirement(), isAutoMergeCloudsIntoDatacenterUnlockAvailable(), isAutoMergeClustersIntoNetworkUnlockAvailable(), isAutoMergeCoresIntoNodeUnlockAvailable(), isAutoMergeDatacentersIntoSupercomputerUnlockAvailable(), isAutoMergeFabricsIntoCloudUnlockAvailable() (+36 more)

### Community 5 - "ComputePage/index.jsx"
Cohesion: 0.06
Nodes (32): COMPUTE_BOOST_MAX_STACKS, COMPUTE_ENTITY_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow (+24 more)
...
Cohesion: 0.20
Nodes (23): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoScaleUp(), buyComputeAutoBoost(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer(), buyTickspeedAutobuyer() (+15 more)

### Community 8 - "engine.js"
Cohesion: 0.06
Nodes (61): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), canForfeitComputeBoost(), clearDiskBuildQueue(), COMPUTE_MERGE_TIMER_FIELDS (+53 more)

### Community 9 - "DiskArrayRow/index.jsx"
Cohesion: 0.10
Nodes (27): CacheBlock, CacheBlocksRow, CacheFillIndicator, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, pullPulse (+19 more)

### Community 10 - "styled-components"
Cohesion: 0.14
...
### Community 15 - "getIntroProductionRate"
Cohesion: 0.18
Nodes (11): getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction(), getDataStreamMultiplierPercent(), getDataStreamSpeedBytesPerSecond(), getIntroProductionRate() (+3 more)
...
Cohesion: 0.13
Nodes (18): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+10 more)
...
Cohesion: 0.08
Nodes (70): allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createInitialGameState(), eraGame(), overclockGame(), prestigeGame() (+62 more)

### Community 25 - "tokens.js"
Cohesion: 0.15
Nodes (13): GlobalStyle, ThemeProvider(), buildTheme(), DEFAULT_MODE, font, MODES, motion, palette (+5 more)
...
Cohesion: 0.11
Nodes (18): AUTO_SCALE_UP_COST, BYTES_ID, COMPUTE_FLOPS_FIRST_TIER_COST_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST, INTRO_CONVERSION_UNLOCK_CAPACITY, INTRO_DISK_UNLOCK_CAPACITY (+10 more)
...
Cohesion: 0.18
Nodes (16): getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getNextBytePowerProgressFraction(), getOverclockMultiplier(), getScaleUpMultiplier(), getTickspeedProductionMultiplier(), getTierProductionProgressPercent() (+8 more)
...
Cohesion: 0.21
Nodes (22): getDiskCost(), getDiskProvisionPassesCollected(), getDiskProvisionPassesRequired(), getDiskReplayPassAllowance(), getDiskSize(), getMaxActiveDiskLadderStep(), getPoolBufferBits(), getPoolCacheReservationBits() (+14 more)
...
Cohesion: 0.05
Nodes (25): captureFoundryUpgradeCaps(), clearIntroCapacityUpgradeQueue(), getNextSiDoubledValue(), isAnyComputeMergeInFlight(), mergeFoundryUpgradeCaps(), resetByteFoundry(), eraEligibleState(), getFinalPoolCapacityCapBits() (+17 more)
...
Cohesion: 0.10
Nodes (19): TIER_UNLOCK_PREV_LEVEL_REQUIREMENT, CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP (+11 more)
...
Cohesion: 0.12
Nodes (27): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getFillMultiplierPercent(), getPoolBaseMultiplierPercent() (+19 more)
...
### Community 63 - "getDiskLadderSizeBits"
Cohesion: 0.47
...
### Community 102 - "buyGlobalTickspeedMultiplier"
Cohesion: 0.67
...
- **Why does `styled-components` connect `styled-components` to `MainPage/index.jsx`, `MilestonesPage/index.jsx`, `package.json`, `ComputePage/index.jsx`, `ByteFoundryPage/index.jsx`, `DiskArrayRow/index.jsx`, `App.jsx`, `DataLakePanel/index.jsx`, `AppMenu/index.jsx`, `ComputeFlopsPage/index.jsx`, `InfoPage/index.jsx`, `DevModePage/index.jsx`, `Button/index.jsx`, `getDiskSizesToShow`, `SettingsPage/index.jsx`, `tokens.js`?**
