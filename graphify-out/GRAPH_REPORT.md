...
## Corpus Check
- 98 files · ~296,068 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1337 nodes · 3344 edges · 95 communities (78 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.76)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e9764406`
...
Cohesion: 0.09
Nodes (24): floorToDecimals(), formatBitsInNearestUnit(), formatMemoryAmount(), getMemoryUnit(), COMPUTE_ENTITY_CAP, INTRO_CAPACITY_MULTIPLIER, ActionsRow, BalanceText (+16 more)
...
Cohesion: 0.06
Nodes (66): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), buyTierQuantity(), canBuyHyperscaler(), canForfeitComputeBoost(), captureFoundryUpgradeCaps() (+58 more)
...
Cohesion: 0.24
Nodes (12): wouldAutobuyerStall(), buyTier(), getCostEpochExponent(), getPurchaseBlockSize(), getTierAffordableQuantity(), getTierBulkQuantity(), getTierCost(), getTierPurchasedCount() (+4 more)

### Community 48 - "MainPage"
Cohesion: 0.15
Nodes (23): countGlobalTickspeedMilestones(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getAutobuyerUnlockCost(), getAutoPrestigeCost(), getEffectiveTierTickSpeedSeconds() (+15 more)
...
Cohesion: 0.15
Nodes (31): actFoundry(), activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), claimComputeCore(), eraseAllComputeTokens(), getComputeBoostTierDurationSeconds() (+23 more)
...
Cohesion: 0.08
Nodes (63): allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createInitialGameState(), eraGame(), unlockedLastTierState(), withOwned() (+55 more)
...
Cohesion: 0.04
Nodes (28): clearIntroCapacityUpgradeQueue(), getBiggestComputeTierWaitingOnMerge(), getBoosterPurchaseTotalCost(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getDiskReadCacheFlushSeconds(), getIntroProductionRate(), getMaxBoosterPurchasesForCapacity() (+20 more)
...
Cohesion: 0.09
Nodes (38): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DepositRow, DiskArrayRow(), DiskSizeRow, DiskSquare (+30 more)
...
Cohesion: 0.14
Nodes (18): canDepositDiskToDataLake(), canStartDiskWriteCacheMerge(), decrementFullDiskCount(), depositDiskToDataLake(), getDataLakeSubSize(), getDataLakeTierIndex(), getDiskBuildBaseSeconds(), getDiskBuildSeconds() (+10 more)
...
Cohesion: 0.20
Nodes (22): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer(), buyTickspeedAutobuyer() (+14 more)

### Community 67 - "getSpeedUpRequirement"
Cohesion: 0.21
Nodes (12): buyGlobalTickspeedMultiplier(), getGlobalTickspeedMultiplierCost(), getSpeedUpRequirement(), isGlobalTickspeedMultiplierUnlocked(), getTiersAttentionLevel(), hasAffordableFullLevel(), hasAffordableGlobalTickspeed(), hasOverclockAvailable() (+4 more)
...
Cohesion: 0.10
Nodes (19): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_MERGE_DURATION_UPGRADE_COUNT, DATA_LAKE_SLOT_MAX, DATA_LAKE_TIER_LABELS, DISK_LADDER_BASE_SIZE_BITS (+11 more)
...
### Community 74 - "formatOfflineDuration"
Cohesion: 0.33
...
Cohesion: 0.24
Nodes (13): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getIntroKilobyteConversionCost(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), isBitFundedBandwidthAvailable(), isComputeFundedBandwidthAvailable() (+5 more)
...
### Community 78 - "getNavAttention"
Cohesion: 0.29
Nodes (10): isComputeUpgradeTurnAvailable(), isStorageUnlocked(), getComputeAttentionLevel(), getNavAttention(), getStorageAttentionLevel(), hasComputeAttention(), hasInstantMergeAvailable(), hasStorageAttention() (+2 more)

### Community 79 - "convertIntroBitsToKilobytes"
Cohesion: 0.25
Nodes (9): convertIntroBitsToKilobytes(), getDiskRedeemTierName(), getMatchingTierForDiskSize(), getRelevantDiskSizesForFoundry(), getTierDiskRedeemCost(), grantTierUnits(), latchEverUnlockedTiers(), redeemDisk() (+1 more)
...
### Community 82 - "getDiskSizesToShow"
Cohesion: 0.40
...
### Community 85 - "hasFoundryAttention"
Cohesion: 0.60
Nodes (5): isBandwidthTurnAvailable(), getFoundryAttentionLevel(), hasFoundryAttention(), isCombineAvailable(), isMemoryFull()
