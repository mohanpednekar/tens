...
## Corpus Check
- 107 files · ~368,164 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1508 nodes · 3782 edges · 100 communities (76 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `957f9ec7`
...
Cohesion: 0.03
Nodes (65): applyOfflineProgress(), canForfeitComputeBoost(), doubleDataLakeCapacity(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud (+57 more)
...
Cohesion: 0.06
Nodes (46): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_FLOPS_TIER_BY_ID, COMPUTE_FLOPS_TIER_INDEX_BY_ID (+38 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.09
Nodes (24): formatBitsInNearestUnit(), getMemoryUnit(), COMPUTE_ENTITY_CAP, ActionsRow, BalanceText, DataStreamCard, FillableStatCard, formatMemoryBalance() (+16 more)
...
Cohesion: 0.12
Nodes (27): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolBufferCapacity() (+19 more)
...
Cohesion: 0.06
Nodes (49): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), clearIntroCapacityUpgradeQueue(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL (+41 more)
...
### Community 39 - "AppNav/index.jsx"
Cohesion: 0.20
Nodes (9): APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar, Icon, Label, NavItem, pulseHigh (+1 more)

### Community 48 - "useIncrementalGame"
Cohesion: 0.08
Nodes (70): allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), captureFoundryUpgradeCaps(), createEmptyDataLakes(), createInitialGameState(), eraGame(), mergeFoundryUpgradeCaps() (+62 more)
...
Cohesion: 0.06
Nodes (30): ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow, canMerge(), CompactButton, COMPUTE_BOOST_DISPLAY (+22 more)
...
Cohesion: 0.11
Nodes (14): seedDataLakeSave(), ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_CORES_PER_NODE (+6 more)
...
Cohesion: 0.14
Nodes (35): actFoundry(), activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), canStartBoosterTransfer(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField() (+27 more)
...
### Community 65 - "isProductionFrozen"
Cohesion: 0.15
Nodes (24): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyGlobalTickspeedMultiplier(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer() (+16 more)

### Community 66 - "run-simulation.mjs"
Cohesion: 0.10
Nodes (29): actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+21 more)
...
Cohesion: 0.11
Nodes (19): AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_FLOPS_FIRST_TIER_COST_PP, COMPUTE_FLOPS_REVEAL_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST, INTRO_CONVERSION_UNLOCK_CAPACITY (+11 more)

### Community 69 - "pickIntroProductionMilestone"
Cohesion: 0.15
Nodes (18): applyIntroProductionDoublingToIntro(), combineIntroByte(), eraseAllComputeTokens(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims() (+10 more)

### Community 70 - "getNavAttention"
Cohesion: 0.28
Nodes (9): isStorageUnlocked(), getComputeFlopsAttentionLevel(), getNavAttention(), getStorageAttentionLevel(), getTiersAttentionLevel(), hasAffordableComputeFlopsTier(), hasStorageAttention(), hasTiersAttention() (+1 more)

### Community 71 - "DataLakePanel/index.jsx"
Cohesion: 0.08
Nodes (49): BalanceText, BareDivider, clampPercent(), DataLakePanel(), FillableStatCard, getVisibleLakeTierIndexes(), LakeActionsRow, LakeBlock (+41 more)

### Community 72 - "AppMenu/index.jsx"
Cohesion: 0.29
Nodes (6): AppMenu(), Backdrop, Icon, MenuButton, Sheet, SheetTitle

### Community 73 - "hasFoundryAttention"
Cohesion: 0.47
...
### Community 80 - "clampNonNegative"
Cohesion: 0.20
Nodes (22): actMainBuys(), wouldAutobuyerStall(), buyTier(), buyTierQuantity(), checkMilestones(), clampNonNegative(), getAutoPrestigeAttemptRate(), getComputeFlopsTierProductionMultiplier() (+14 more)
...
## Knowledge Gaps
- **609 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+604 more)
...
- **Should `engine.test.js` be split into smaller, more focused modules?**
  _Cohesion score 0.0313573883161512 - nodes in this community are weakly interconnected._
