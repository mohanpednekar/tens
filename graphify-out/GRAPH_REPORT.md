...
## Corpus Check
- 107 files · ~335,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1480 nodes · 3738 edges · 96 communities (78 shown, 18 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f576a1c`
...
Cohesion: 0.17
Nodes (29): actFoundry(), activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), canStartBoosterTransfer(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField() (+21 more)
...
### Community 8 - "isDiskRedeemable"
Cohesion: 0.21
Nodes (15): getDiskWriteCacheMerge(), getMatchingTierForDiskSize(), hasFullRedeemableDiskAtSize(), isDiskAutoRedeemEligible(), isDiskCacheBlockAutoReleaseEligible(), isDiskCacheBlockManualReleaseAvailable(), isDiskCacheBlockReleasable(), isDiskManualRedeemAvailable() (+7 more)
...
Cohesion: 0.29
Nodes (8): floorToDecimals(), formatBitsInNearestSiUnit(), formatBitsInNearestUnit(), formatMemoryAmount(), getMemoryUnit(), getSiByteUnit(), formatMemoryBalance(), InfoPage()

### Community 52 - "DevModePage/index.jsx"
Cohesion: 0.06
Nodes (40): seedState(), applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), COMPUTE_FLOPS_TIER_DEFINITIONS, ERA_ELIGIBILITY_PP, PRESTIGE_THRESHOLD (+32 more)

### Community 53 - "storage.js"
Cohesion: 0.06
Nodes (75): applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), eraGame(), getEonsAwarded(), isEraEligible(), normalizePoolMemoryCapacity(), INTRO_CAPACITY_CAP_BITS (+67 more)
...
### Community 57 - "MainPage"
Cohesion: 0.21
Nodes (17): countGlobalTickspeedMilestones(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier() (+9 more)

### Community 58 - "navAttention.test.js"
Cohesion: 0.12
Nodes (17): seedDataLakeSave(), allResourceIds(), createInitialGameState(), BYTES_ID, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, DISK_ARRAY_LADDER_CAP, INTRO_BYTE_COMBINE_COST (+9 more)
...
Cohesion: 0.09
Nodes (28): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, manualPulse (+20 more)

### Community 62 - "ByteFoundryPage"
Cohesion: 0.13
Nodes (24): applyIntroProductionDoublingToIntro(), combineIntroByte(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getDiskSize(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost() (+16 more)
...
Cohesion: 0.11
Nodes (15): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_PRESETS, COMPUTE_CORES_PER_NODE, COMPUTE_ENTITY_CAP (+7 more)

### Community 65 - "DataLakePanel/index.jsx"
Cohesion: 0.11
Nodes (32): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeGrid, LakeHeaderRow, LakeName (+24 more)
...
Cohesion: 0.05
Nodes (25): getComputeBoostMultiplier(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), startComputeMergeReserve(), startComputeMergeReserveAtBoundary(), eraEligibleState(), noOtherUpgradesLeft, unlockedLastTierState() (+17 more)

### Community 68 - "getUnlockedStoragePoolCount"
Cohesion: 0.16
Nodes (16): eraseAllComputeTokens(), getPoolLastDiskSize(), getStoragePoolCapacity(), getStoragePoolCount(), getUnlockedStoragePoolCount(), isDataLakeCapacityMaxed(), isIdleDiskLiquidationAvailable(), isMemoryCapacityAtCap() (+8 more)
...
Cohesion: 0.31
Nodes (10): canDepositDiskToDataLake(), depositDiskToDataLake(), getDataLakeSubSize(), getDataLakeTierIndex(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskRequiredTierLevel(), getNextDiskLadderSize() (+2 more)
...
Cohesion: 0.05
Nodes (77): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), canForfeitComputeBoost(), captureFoundryUpgradeCaps(), clearIntroCapacityUpgradeQueue() (+69 more)
...
## Knowledge Gaps
- **591 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+586 more)
