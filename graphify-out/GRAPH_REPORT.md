...
## Corpus Check
- 107 files · ~352,877 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1494 nodes · 3760 edges · 104 communities (78 shown, 18 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `21cd98ef`
...
Cohesion: 0.06
Nodes (49): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_FLOPS_TIER_BY_ID (+41 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.08
Nodes (41): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getDiskSize(), getDiskSizesToShow(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost() (+33 more)
...
Cohesion: 0.09
Nodes (25): getAutobuyerUnlockMilestone(), getTierTickspeedAutobuyerMilestone(), CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER (+17 more)
...
Cohesion: 0.05
Nodes (16): canForfeitComputeBoost(), clearIntroCapacityUpgradeQueue(), eraseAllComputeTokens(), forfeitComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostMultiplier(), isAnyComputeMergeInFlight(), releaseDiskCacheBlock() (+8 more)
...
Cohesion: 0.18
Nodes (25): actMainBuys(), wouldAutobuyerStall(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getAutoPrestigeAttemptRate(), getCostEpochExponent(), getIntroKilobyteConversionCost() (+17 more)
...
Cohesion: 0.06
Nodes (37): canReclaimComputeBoost(), canStartBoosterTransfer(), getComputeBoostTierMultiplier(), getNextComputeMergeDurationUpgradeIndex(), isValidComputeBoostTier(), reclaimComputeBoost(), ActiveBoostRow, ArmedStatusText (+29 more)

### Community 51 - "isBandwidthAvailable"
Cohesion: 0.27
Nodes (15): activateComputeBoost(), canActivateComputeBoost(), canStackComputeBoost(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), isBandwidthAvailable(), isComputeBoostTurnAvailable(), isComputeUpgradeAvailable() (+7 more)
...
Cohesion: 0.24
Nodes (11): actFoundry(), combineIntroByte(), isDiskBuildBelowCap(), isInvestProgressBelowCap(), isMemoryCapacityUpgradeAvailable(), pickIntroCapacityMilestone(), rewindOneIntroProductionClaim(), rollbackComputeFundedBandwidth() (+3 more)
...
### Community 69 - "isAutoMergeUnlockAvailable"
Cohesion: 0.18
...
### Community 70 - "isComputeMergeReserveStartAvailable"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (43): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeGrid, LakeHeaderRow, LakeName (+35 more)
...
Cohesion: 0.14
Nodes (31): isBandwidthTurnAvailable(), isComputeCoreConversionUnlocked(), isComputeUpgradeTurnAvailable(), isDiskFillAvailable(), isIntroConversionUnlocked(), isStorageUnlocked(), ATTENTION_NORMAL, COMPUTE_AUTO_MERGE_UNLOCKS (+23 more)

### Community 86 - "buyGlobalTickspeedMultiplier"
Cohesion: 0.67
...
### Community 91 - "applyOfflineProgress"
Cohesion: 1.00
...
Cohesion: 0.12
Nodes (26): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getNextSiDoubledValue(), getPoolBufferCapacity(), getPoolIndexForDiskSize() (+18 more)
...
## Knowledge Gaps
- **599 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+594 more)
