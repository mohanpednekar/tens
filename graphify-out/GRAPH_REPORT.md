...
## Corpus Check
- 108 files · ~414,794 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1578 nodes · 3979 edges · 100 communities (80 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26cef03b`
...
Cohesion: 0.08
Nodes (71): allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createInitialGameState(), eraGame(), normalizePoolMemoryCapacity(), prestigeGame() (+63 more)
...
Cohesion: 0.07
Nodes (33): getDiskCost(), FILL_MULTIPLIER_TAP_CAP_PERCENT, ActionsRow, BalanceText, clampGaugeValue(), clampPercent(), DataStreamCard, ExpandToggleButton (+25 more)
...
Cohesion: 0.17
Nodes (17): getDecadePowerEquivalentBits(), getPoolBufferCapacity(), getPoolEffectMultiplier(), getPoolMultiplierPercent(), getPoolTapBonusPercent(), getStoragePoolCapacity(), getStoragePoolCount(), getUnlockedStoragePoolCount() (+9 more)
...
Cohesion: 0.16
Nodes (15): actFoundry(), combineIntroByte(), eraseAllComputeTokens(), getDiskProvisionPassesCollected(), getProvisionDiskSeconds(), isDiskBuildBelowCap(), isInvestProgressBelowCap(), pickIntroCapacityMilestone() (+7 more)

### Community 20 - "engine.test.js"
Cohesion: 0.05
Nodes (27): canForfeitComputeBoost(), clearIntroCapacityUpgradeQueue(), forfeitComputeBoost(), getComputeBoostMultiplier(), getCoreEarnTimeSeconds(), getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction() (+19 more)
...
Cohesion: 0.15
Nodes (28): actMainBuys(), wouldAutobuyerStall(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getAutoPrestigeAttemptRate(), getCostEpochExponent(), getIntroKilobyteConversionCost() (+20 more)

### Community 48 - "activateComputeBoost"
Cohesion: 0.27
Nodes (11): activateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), getComputeBoostTierMultiplier(), isValidComputeBoostTier() (+3 more)
...
Cohesion: 0.06
Nodes (33): getNextComputeMergeDurationUpgradeIndex(), COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow (+25 more)

### Community 51 - "engine.js"
Cohesion: 0.06
Nodes (61): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyHyperscaler(), canBuyHyperscaler(), captureFoundryUpgradeCaps(), clearDiskBuildQueue(), COMPUTE_MERGE_TIMER_FIELDS (+53 more)
...
Cohesion: 0.10
Nodes (16): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_CORES_PER_NODE, COMPUTE_ENTITY_CAP (+8 more)
...
Cohesion: 0.10
Nodes (19): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, DATA_LAKE_OVERFLOW_MIN_PERCENT, DATA_LAKE_SUB_SIZE_DISK_CAPS (+11 more)
...
Cohesion: 0.18
Nodes (25): applyIntroProductionDoublingToIntro(), canActivateComputeBoost(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskSize(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims() (+17 more)
...
Cohesion: 0.09
Nodes (27): react, web-vitals, App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), APP_NAV_BOTTOM_PAD, AppNav() (+19 more)

### Community 65 - "buyGlobalTickspeedMultiplier"
Cohesion: 0.32
...
Cohesion: 0.10
Nodes (24): actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues, emit() (+16 more)

### Community 70 - "formatMemoryAmount"
Cohesion: 0.22
...
Cohesion: 0.18
Nodes (17): decrementFullDiskCount(), getDataLakeCapacityUnlockArraySize(), getDataLakeSubSizeStep(), getDataLakeTierIndex(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskReadCacheFlushSeconds(), getDiskSizeForTierLevel() (+9 more)

### Community 73 - "clampNonNegative"
Cohesion: 0.17
Nodes (26): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus(), buySmartAutobuyer(), buyTickspeedAutobuyer() (+18 more)
...
### Community 75 - "buyTickspeedMultiplier"
Cohesion: 0.39
...
### Community 84 - "isDiskPullEligible"
Cohesion: 0.38
Nodes (7): getDataLakeSubSize(), getDiskRequiredTierLevel(), getMatchingTierForDiskSize(), isDiskPullEligible(), isDiskReadCacheEligible(), pullDiskForCurrentLevel(), tickDiskPull()
...
Cohesion: 0.20
Nodes (15): countGlobalTickspeedMilestones(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getNextBytePowerProgressFraction(), getOverclockMultiplier(), getTickspeedProductionMultiplier(), getTierProductionProgressPercent() (+7 more)
...
- **Why does `styled-components` connect `styled-components` to `App.jsx`, `MainPage/index.jsx`, `ByteFoundryPage/index.jsx`, `DataLakePanel/index.jsx`, `StoragePage/index.jsx`, `AppMenu/index.jsx`, `package.json`, `ComputePage/index.jsx`, `DevModePage/index.jsx`, `ComputeFlopsPage/index.jsx`, `MilestonesPage/index.jsx`, `SettingsPage/index.jsx`, `InfoPage/index.jsx`, `Button/index.jsx`, `DiskArrayRow/index.jsx`?**
...
- **Why does `react` connect `App.jsx` to `MainPage/index.jsx`, `ByteFoundryPage/index.jsx`, `package.json`, `engine.js`, `ComputePage/index.jsx`, `DevModePage/index.jsx`, `SettingsPage/index.jsx`, `Button/index.jsx`?**
