...
## Corpus Check
- 102 files · ~314,117 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1391 nodes · 3491 edges · 101 communities (80 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ed33d7bf`
...
- `actFoundry()` --calls--> `setAutobuyerEnabled()`  [EXTRACTED]
  .claude/skills/simulate-run-times/run-simulation.mjs → src/game/engine.js
- `wouldAutobuyerStall()` --calls--> `isTierUnlocked()`  [EXTRACTED]
  .claude/skills/simulate-run-times/run-simulation.mjs → src/game/engine.js
...
Cohesion: 0.03
Nodes (62): getNextBytePowerProgressFraction(), BalancesSentinel, BuyButton, BuyButtonCostLabel, BuyButtonIcon, BytePowerSegment, BytePowerSegmentFill, BytePowerSegments (+54 more)

### Community 2 - "layers.js"
Cohesion: 0.06
Nodes (49): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTO_SPEED_UP_COST, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP (+41 more)

### Community 3 - "App.jsx"
Cohesion: 0.11
Nodes (24): App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar (+16 more)
...
Cohesion: 0.19
Nodes (23): buyGlobalTickspeedMultiplier(), getGlobalTickspeedMultiplierCost(), getIntroKilobyteConversionCost(), getSmartAutobuyerCost(), isGlobalTickspeedMultiplierUnlocked(), isIntroConversionUnlocked(), isProductionFrozen(), isTierUnlocked() (+15 more)
...
Cohesion: 0.05
Nodes (84): actFoundry(), activateComputeBoost(), applyIntroProductionDoublingToIntro(), canActivateComputeBoost(), canStackComputeBoost(), combineIntroByte(), eraseAllComputeTokens(), floorToDecimals() (+76 more)
...
Cohesion: 0.05
Nodes (14): clearIntroCapacityUpgradeQueue(), getAutobuyerUnlockCost(), getTickspeedMultiplierBaseCost(), getTickspeedMultiplierCost(), isAnyComputeMergeInFlight(), eraEligibleState(), noOtherUpgradesLeft, unlockedLastTierState() (+6 more)
...
Cohesion: 0.21
Nodes (19): BareDivider, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeList, LakeName, LakeRow, LakeStats (+11 more)

### Community 48 - "MainPage"
Cohesion: 0.16
Nodes (18): checkMilestones(), countGlobalTickspeedMilestones(), getAutoPrestigeAttemptRate(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getMoneyExponent(), getOverclockMultiplier(), getPrestigeDoublePpHalvingLevels() (+10 more)
...
Cohesion: 0.07
Nodes (35): canReclaimComputeBoost(), canStartBoosterTransfer(), getDataLakeAvailableUnits(), getNextComputeMergeDurationUpgradeIndex(), ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow (+27 more)
...
Cohesion: 0.17
Nodes (29): buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage(), clearAllSaveProgress(), clearDevGameState(), clearGameState(), clearSaveSlot(), completeDummySupporterPurchase(), discardIncompatibleActiveSaveIfNeeded() (+21 more)

### Community 54 - "startBoosterTransfer"
Cohesion: 0.33
Nodes (10): decomposeDataLakeDeposits(), getBoosterTransferPlan(), getDataLakeSubSizeStep(), getDataLakeTransferCapacity(), getDataLakeTransferDurationSeconds(), getDiskLadderSizeBits(), latchComputeMergePageIfNeeded(), planLiveDiskFunding() (+2 more)
...
Cohesion: 0.11
Nodes (24): formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEonsAwarded(), isEraEligible(), RESOURCE_SYMBOL(), formatCost() (+16 more)

### Community 58 - "tickGame"
Cohesion: 0.17
Nodes (25): actMainBuys(), actTickspeed(), wouldAutobuyerStall(), buyTickspeedMultiplier(), buyTier(), buyTierQuantity(), consumeXpForLastTierTickspeed(), convertIntroBitsToKilobytes() (+17 more)
...
Cohesion: 0.09
Nodes (18): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_BOOST_PRESETS, COMPUTE_CORES_PER_NODE (+10 more)

### Community 65 - "engine.js"
Cohesion: 0.07
Nodes (39): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, canStartDiskWriteCacheMerge(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, decrementFullDiskCount(), formatBitsInNearestSiUnit() (+31 more)
...
### Community 67 - "getComputeBoostTierMultiplier"
Cohesion: 0.67
...
Cohesion: 0.09
Nodes (22): version, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER (+14 more)
...
### Community 84 - "storage.js"
Cohesion: 0.23
Nodes (18): createEmptyDataLakes(), applyDevGameStateJson(), buildDefaultMeta(), coerceMeta(), defaultSlotName(), hasStoredStateForSlot(), isPlainObject(), listSaveSlots() (+10 more)

### Community 85 - "applyOfflineProgress"
Cohesion: 1.00
Nodes (3): applyOfflineProgress(), getOfflineEffectiveSeconds(), computeOfflineCatchUp()

### Community 86 - "save-migration/index.js"
Cohesion: 0.36
...
Cohesion: 0.22
Nodes (10): seedDataLakeSave(), allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), captureFoundryUpgradeCaps(), createInitialGameState(), eraGame(), mergeFoundryUpgradeCaps() (+2 more)
...
## Knowledge Gaps
- **556 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+551 more)
