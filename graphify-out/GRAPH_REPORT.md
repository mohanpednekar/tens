...
## Corpus Check
- 68 files · ~230,181 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 855 nodes · 1745 edges · 67 communities (55 shown, 12 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `540a3b0a`
...
Cohesion: 0.09
Nodes (32): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTO_SPEED_UP_COST, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, GLOBAL_TICKSPEED_MILESTONE_STEP (+24 more)

### Community 3 - "engine.js"
Cohesion: 0.11
Nodes (28): AUTO_MERGE_TICKERS, currencyNumberFormatter, enableAutoMerge(), getDiskBuildBaseSeconds(), getDiskBuildSeconds(), getFirstTierCost(), getMatchingTierForDiskSize(), getTierDiskRedeemCost() (+20 more)
...
Cohesion: 0.07
Nodes (51): allResourceIds(), applyAutobuyerMilestones(), applyOfflineProgress(), combineIntroByte(), createInitialGameState(), enableAutoClaimCore(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork (+43 more)
...
Cohesion: 0.13
Nodes (30): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyPrestigeSpeedBonus(), buySmartAutobuyer(), buyTickspeedAutobuyer(), buyTickspeedMultiplier(), checkMilestones() (+22 more)

### Community 48 - "StoragePage/index.jsx"
Cohesion: 0.15
Nodes (16): formatDiskSize, getDiskRedeemTierName(), getDiskSizesToShow(), isDiskCacheBlockReleasable(), releaseDiskCacheBlock(), CacheBlock, CacheBlocksRow, DiskSizeLabel (+8 more)
...
Cohesion: 0.11
Nodes (18): ActiveBoostRow, AutoBadge, BoostRow, canMerge(), CompactButton, COMPUTE_BOOST_DISPLAY, CoresAvailable, ENTITY_ROWS (+10 more)

### Community 51 - "App.test.jsx"
Cohesion: 0.11
Nodes (14): version, ALL_TIER_IDS, AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BITS_PER_KILOBYTE_CONVERSION (+6 more)

### Community 52 - "buyTier"
Cohesion: 0.23
Nodes (12): buyTier(), buyTierQuantity(), getCostEpochExponent(), getTierAffordableQuantity(), getTierBulkQuantity(), getTierCost(), getTierPurchasedCount(), getTierQuantityCost() (+4 more)

### Community 53 - "ComputePage"
Cohesion: 0.19
Nodes (16): activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), getDiskCost(), getDiskSize(), isComputeBoostTurnAvailable(), isComputeUpgradeAvailable(), isComputeUpgradeTurnAvailable() (+8 more)
...
Cohesion: 0.36
Nodes (5): cliValues, defaultPPValues, simulateRun(), getSpeedUpRequirement(), speedUpGame()

### Community 58 - "InfoPage/index.jsx"
Cohesion: 0.12
Nodes (15): COMPUTE_BOOST_PRESETS, COMPUTE_CORES_PER_NODE, COMPUTE_ENTITY_CAP, DISK_ARRAY_LADDER_CAP, DISK_BUILD_COST_MULTIPLIER, DISK_CACHE_BLOCK_COUNT, INTRO_BYTE_COMBINE_COST, INTRO_CAPACITY_MULTIPLIER (+7 more)
...
Cohesion: 0.31
Nodes (10): getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), getIntroProductionRate(), isBandwidthAvailable(), isBandwidthTurnAvailable(), isIntroConversionUnlocked(), isStorageUnlocked(), pickIntroProductionMilestone() (+2 more)

### Community 63 - "MainPage"
Cohesion: 0.14
Nodes (20): buyGlobalTickspeedMultiplier(), countGlobalTickspeedMilestones(), getAutobuyerUnlockCost(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedMultiplierCost(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getOverclockMultiplier() (+12 more)
...
### Community 65 - "getPurchaseBlockSize"
Cohesion: 0.40
Nodes (5): convertIntroBitsToKilobytes(), getIntroKilobyteConversionCost(), getPurchaseBlockSize(), withLastTierTickspeedXpUnlocked(), tickIntroAutoInvest()

### Community 66 - "formatCurrency"
Cohesion: 0.60
Nodes (5): formatCurrency(), formatMoneyBalance(), formatScientific(), RESOURCE_SYMBOL(), formatCost()

## Knowledge Gaps
- **400 isolated node(s):** `session-start.sh script`, `defaultPPValues`, `cliValues`, `seededState`, `baseUrl` (+395 more)
