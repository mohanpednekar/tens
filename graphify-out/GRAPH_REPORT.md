...
## Corpus Check
- 107 files · ~344,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1483 nodes · 3744 edges · 100 communities (75 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62ac031a`
...
Cohesion: 0.17
Nodes (20): countGlobalTickspeedMilestones(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEffectiveTierTickSpeedSeconds(), getEonsAwarded(), getGlobalTickspeedProductionMultiplier() (+12 more)
...
Cohesion: 0.05
Nodes (54): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_FLOPS_TIER_BY_ID, COMPUTE_FLOPS_TIER_INDEX_BY_ID (+46 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.06
Nodes (58): applyIntroProductionDoublingToIntro(), floorToDecimals(), formatBitsInNearestUnit(), formatMemoryAmount(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getDiskReadCacheFlushSeconds() (+50 more)
...
Cohesion: 0.11
Nodes (18): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, DATA_LAKE_CAPACITY_BY_LEVEL (+10 more)
...
Cohesion: 0.14
Nodes (29): actMainBuys(), wouldAutobuyerStall(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getAutoPrestigeAttemptRate(), getCostEpochExponent(), getIntroKilobyteConversionCost() (+21 more)
...
Cohesion: 0.05
Nodes (9): canForfeitComputeBoost(), clearIntroCapacityUpgradeQueue(), forfeitComputeBoost(), isAnyComputeMergeInFlight(), isUpgradeComputeMergeDurationAvailable(), noOtherUpgradesLeft, unlockedLastTierState(), withOwned() (+1 more)
...
Cohesion: 0.06
Nodes (30): COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow, CompactButton (+22 more)
...
Cohesion: 0.06
Nodes (54): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, manualPulse (+46 more)

### Community 62 - "ComputePage"
Cohesion: 0.33
Nodes (6): canStartBoosterTransfer(), getDataLakeTierLabel(), getNextComputeMergeDurationUpgradeIndex(), canMerge(), ComputePage(), singularize()
...
### Community 64 - "engine.computeFlops.test.js"
Cohesion: 0.33
...
Cohesion: 0.10
Nodes (28): actFoundry(), actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+20 more)

### Community 67 - "useIncrementalGame.js"
Cohesion: 0.05
Nodes (36): enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud, enableAutoMergeGridsIntoFabric, enableAutoMergeNetworksIntoGrid, enableAutoMergeNodesIntoCluster (+28 more)

### Community 68 - "getDiskLadderSizeBits"
Cohesion: 0.47
Nodes (6): getDataLakeSubSizeStep(), getDataLakeTransferCapacity(), getDataLakeTransferDurationSeconds(), getDataLakeUnitBits(), getDiskLadderSizeBits(), planLiveDiskFunding()

### Community 69 - "ComputeFlopsPage/index.jsx"
Cohesion: 0.12
Nodes (24): ButtonContent(), Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), formatAmount(), formatComputeFlopsBoost(), formatComputeFlopsTotal(), getComputeFlopsTierCost() (+16 more)

### Community 70 - "engine.js"
Cohesion: 0.07
Nodes (54): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, eraseAllComputeTokens(), formatBitsInNearestSiUnit(), getComputeMergeDurationSeconds() (+46 more)
...
Cohesion: 0.05
Nodes (72): APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar, Icon, Label, NavItem, pulseHigh (+64 more)
...
### Community 90 - "getComputeBoostTierMultiplier"
Cohesion: 0.67
