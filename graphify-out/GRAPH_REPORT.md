...
## Corpus Check
- 108 files · ~421,117 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1588 nodes · 4000 edges · 96 communities (77 shown, 16 thin omitted)
...
Cohesion: 0.05
Nodes (85): applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createEmptyDataLakeTier(), eraGame(), getEonsAwarded(), isEraEligible(), normalizePoolMemoryCapacity() (+77 more)
...
Cohesion: 0.04
Nodes (60): activateComputeBoost(), applyOfflineProgress(), canForfeitComputeBoost(), clearDiskBuildQueue(), clearIntroCapacityUpgradeQueue(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode (+52 more)
...
Cohesion: 0.08
Nodes (34): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_OVERFLOW_SEGMENT_LIMIT, fixedMemoryAmountFormatter, getComputeMergeDurationSeconds(), LOG10_2 (+26 more)

### Community 7 - "ComputePage/index.jsx"
Cohesion: 0.07
Nodes (37): canReclaimComputeBoost(), getComputeBoostMultiplier(), getComputeBoostTierDurationSeconds(), getComputeBoostTierMultiplier(), getNextComputeMergeDurationUpgradeIndex(), isValidComputeBoostTier(), reclaimComputeBoost(), ActiveBoostRow (+29 more)

### Community 8 - "clampNonNegative"
Cohesion: 0.15
Nodes (29): buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyComputeFlopsTier(), buyHyperscaler(), buyPrestigeDoublePp(), buyPrestigeSpeedBonus() (+21 more)
...
Cohesion: 0.20
Nodes (14): getCoreEarnTimeSeconds(), getDecadePowerEquivalentBits(), getIntroProductionRate(), getPoolBufferCapacity(), getPoolEffectMultiplier(), getPoolMultiplierPercent(), getPoolTapBonusPercent(), getStoragePoolCapacity() (+6 more)
...
Cohesion: 0.14
Nodes (18): actFoundry(), buyBooster(), combineIntroByte(), eraseAllComputeTokens(), getPoolCapacityUnlockThresholdBits(), getVisibleStoragePoolCount(), isInvestProgressBelowCap(), latchComputeMergePageIfNeeded() (+10 more)

### Community 13 - "DiskArrayRow/index.jsx"
Cohesion: 0.06
Nodes (54): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, pullPulse (+46 more)

### Community 14 - "getPoolBufferBits"
Cohesion: 0.24
Nodes (10): getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction(), getDataStreamMultiplierPercent(), getFillMultiplierPercent(), getPoolBaseMultiplierPercent(), getPoolBufferBits(), getPoolBufferFillFraction() (+2 more)
...
Cohesion: 0.07
Nodes (24): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_BOOST_PRESETS, COMPUTE_CORES_PER_NODE (+16 more)
...
Cohesion: 0.12
Nodes (20): VisuallyHidden, NoticeText, OfflineNoticeCard, OfflineNoticeOverlay, OfflineProgressNotice(), formatOfflineDuration(), getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra() (+12 more)
...
Cohesion: 0.20
Nodes (12): seedState(), seedDataLakeSave(), allResourceIds(), applyAutobuyerMilestones(), captureFoundryUpgradeCaps(), createInitialGameState(), mergeFoundryUpgradeCaps(), prestigeGame() (+4 more)

### Community 22 - "InfoPage/index.jsx"
Cohesion: 0.07
Nodes (27): version, formatBitsInNearestUnit(), CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_LAST_TIER_COST_PP (+19 more)

### Community 23 - "getTierCost"
Cohesion: 0.25
Nodes (11): buyTier(), convertIntroBitsToKilobytes(), getCostEpochExponent(), getIntroKilobyteConversionCost(), getTierCost(), getTierPurchasedCount(), getTierQuantityCost(), grantTierUnits() (+3 more)

### Community 24 - "run-simulation.mjs"
Cohesion: 0.11
Nodes (32): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+24 more)
...
### Community 28 - "isProvisionDiskAvailable"
Cohesion: 0.23
Nodes (13): canActivateComputeBoost(), canStackComputeBoost(), getComputeBoostTierField(), isComputeBoostTurnAvailable(), isComputeUpgradeAvailable(), isDataLakeCapacityDoublingTurnAvailable(), isDiskFillAvailable(), isMemoryCapacityAtCap() (+5 more)
...
Cohesion: 0.26
Nodes (15): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskCost(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), isBandwidthAvailable() (+7 more)
...
### Community 38 - "getDiskSize"
Cohesion: 0.33
Nodes (6): getDiskProvisionPassesCollected(), getDiskSize(), getMaxActiveDiskLadderStep(), isDiskBuildBelowCap(), isDiskLadderExhaustedForActivePools(), queueDiskBuild()
...
Cohesion: 0.13
Nodes (30): actTickspeed(), buyGlobalTickspeedMultiplier(), buyTickspeedMultiplier(), consumeXpForLastTierTickspeed(), countGlobalTickspeedMilestones(), getAutoPrestigeAttemptRate(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedMultiplierCost() (+22 more)
...
Cohesion: 0.09
Nodes (27): styled-components, App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), AppMenu(), Backdrop, Icon (+19 more)
...
- **Why does `styled-components` connect `App.jsx` to `storage.js`, `MainPage/index.jsx`, `DataLakePanel/index.jsx`, `ComputePage/index.jsx`, `ByteFoundryPage/index.jsx`, `DiskArrayRow/index.jsx`, `ConfirmDialog/index.jsx`, `DevModePage/index.jsx`, `MilestonesPage/index.jsx`, `ComputeFlopsPage/index.jsx`, `InfoPage/index.jsx`, `package.json`, `AppNav/index.jsx`, `Button/index.jsx`?**
