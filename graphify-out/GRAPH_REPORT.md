...
## Corpus Check
- 107 files · ~359,569 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1501 nodes · 3765 edges · 105 communities (81 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3f8d184b`
...
Cohesion: 0.05
Nodes (68): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, canForfeitComputeBoost(), captureFoundryUpgradeCaps(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL (+60 more)
...
Cohesion: 0.06
Nodes (48): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_FLOPS_TIER_BY_ID, COMPUTE_FLOPS_TIER_INDEX_BY_ID (+40 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.10
Nodes (20): ActionsRow, BalanceText, DataStreamCard, FillableStatCard, Header, MilestoneButtonContent, MilestoneCostLine, MilestonesRow (+12 more)
...
Cohesion: 0.08
Nodes (23): name, packageManager, private, type, version, CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_BOOST_TIER_POWER_STEP (+15 more)
...
Cohesion: 0.10
Nodes (31): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolBufferCapacity() (+23 more)
...
Cohesion: 0.04
Nodes (40): clearIntroCapacityUpgradeQueue(), getComputeBoostMultiplier(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getTickspeedMultiplierBaseCost(), isComputeCloudsMergeStartAvailable(), isComputeClustersMergeStartAvailable(), isComputeCoresMergeStartAvailable() (+32 more)
...
Cohesion: 0.18
Nodes (23): applyFlopsAutobuyerMilestones(), createEmptyDataLakes(), normalizePoolMemoryCapacity(), buildDefaultMeta(), coerceMeta(), completeDummySupporterPurchase(), defaultSlotName(), grantSupporterUnlock() (+15 more)

### Community 48 - "useIncrementalGame"
Cohesion: 0.18
Nodes (25): allResourceIds(), createInitialGameState(), prestigeGame(), speedUpGame(), PRESTIGE_UNBOUNDED_MIN_COUNT, clearAllSaveProgress(), clearDevGameState(), clearGameState() (+17 more)
...
Cohesion: 0.06
Nodes (32): COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_MERGE_STEP_MULTIPLIER, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow, canMerge() (+24 more)
...
Cohesion: 0.11
Nodes (25): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), flooredBitsLabel(), formatAmount(), formatComputeFlopsBoost(), formatComputeFlopsTotal(), getComputeFlopsTierCost() (+17 more)

### Community 53 - "App.test.jsx"
Cohesion: 0.11
Nodes (14): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_CORES_PER_NODE, COMPUTE_ENTITY_CAP (+6 more)
...
Cohesion: 0.10
Nodes (24): buildEraIntroReset(), eraGame(), getEonsAwarded(), isEraEligible(), MUSEUM_PIN_CAP, buildClearSlotConfirmMessage(), buildEraseAllSavesConfirmMessage(), SUPPORTER_UNLOCK_CODE (+16 more)

### Community 58 - "ByteFoundryPage"
Cohesion: 0.11
Nodes (41): activateComputeBoost(), applyIntroProductionDoublingToIntro(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel() (+33 more)
...
Cohesion: 0.13
Nodes (19): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, manualPulse (+11 more)
...
Cohesion: 0.19
Nodes (21): buyTickspeedMultiplier(), countGlobalTickspeedMilestones(), getAutoPrestigeAttemptRate(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierId(), getLastTierXpTickspeedMultiplier(), getNextBytePowerProgressFraction() (+13 more)
...
Cohesion: 0.12
Nodes (17): AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_FLOPS_REVEAL_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST, INTRO_CONVERSION_UNLOCK_CAPACITY, INTRO_DISK_UNLOCK_CAPACITY (+9 more)

### Community 69 - "actFoundry"
Cohesion: 0.16
Nodes (16): actFoundry(), canStartBoosterTransfer(), combineIntroByte(), eraseAllComputeTokens(), getDiskSize(), getMaxActiveDiskLadderStep(), isDiskBuildBelowCap(), isInvestProgressBelowCap() (+8 more)
...
### Community 80 - "buyTierQuantity"
Cohesion: 0.21
Nodes (18): actMainBuys(), wouldAutobuyerStall(), buyTier(), buyTierQuantity(), getCostEpochExponent(), getTierAffordableQuantity(), getTierBulkQuantity(), getTierCost() (+10 more)
...
Cohesion: 0.08
Nodes (43): APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar, Icon, Label, NavItem, pulseHigh (+35 more)
...
### Community 87 - "getDiskSizesToShow"
Cohesion: 0.40
...
### Community 91 - "convertIntroBitsToKilobytes"
Cohesion: 0.67
Nodes (4): convertIntroBitsToKilobytes(), getIntroKilobyteConversionCost(), grantTierUnits(), tickIntroAutoInvest()

### Community 96 - "applyDevGameStateJson"
Cohesion: 1.00
Nodes (3): applyDevGameStateJson(), isPlainObject(), mergeStateForDevWrite()

### Community 97 - "startBoosterTransfer"
Cohesion: 0.28
Nodes (9): decomposeDataLakeDeposits(), getBoosterTransferPlan(), getDataLakeSubSizeStep(), getDataLakeTransferCapacity(), getDataLakeTransferDurationSeconds(), latchComputeMergePageIfNeeded(), planLiveDiskFunding(), startBoosterTransfer() (+1 more)
...
### Community 103 - "buyGlobalTickspeedMultiplier"
Cohesion: 0.67
...
### Community 109 - "isDiskRedeemable"
Cohesion: 0.15
Nodes (20): getDiskReadCacheFlush(), getDiskRedeemTierName(), getDiskRequiredTierLevel(), getDiskWriteCacheMerge(), getMatchingTierForDiskSize(), getRelevantDiskSizesForFoundry(), hasFullRedeemableDiskAtSize(), isDiskAutoRedeemEligible() (+12 more)
