...
## Corpus Check
- 102 files · ~306,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1373 nodes · 3410 edges · 103 communities (82 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `699a33b6`
...
Cohesion: 0.06
Nodes (47): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS (+39 more)

### Community 3 - "engine.js"
Cohesion: 0.08
Nodes (38): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, canStartDiskWriteCacheMerge(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, decrementFullDiskCount(), formatBitsInNearestSiUnit(), getComputeMergeDurationSeconds() (+30 more)
...
Cohesion: 0.09
Nodes (26): floorToDecimals(), formatBitsInNearestUnit(), formatMemoryAmount(), getIntroKilobyteConversionCost(), getMemoryUnit(), isIntroConversionUnlocked(), isTransferBlockAffordable(), ActionsRow (+18 more)
...
Cohesion: 0.05
Nodes (13): clearIntroCapacityUpgradeQueue(), getAutobuyerUnlockCost(), getComputeBoostMultiplier(), getTickspeedMultiplierBaseCost(), getTierProductionProgressPercent(), isAnyComputeMergeInFlight(), noOtherUpgradesLeft, unlockedLastTierState() (+5 more)
...
Cohesion: 0.17
Nodes (19): BareDivider, DataLakePanel(), getVisibleLakeTierIndexes(), LakeList, LakeName, LakeRow, LakeStats, canPurchaseBoosterFromDataLake() (+11 more)

### Community 48 - "getDiskSizesToShow"
Cohesion: 0.33
...
Cohesion: 0.22
Nodes (15): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), getIntroProductionRate(), isBitFundedBandwidthAvailable() (+7 more)
...
Cohesion: 0.12
Nodes (24): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DepositRow, DiskArrayRow(), DiskSizeRow, DiskSquare (+16 more)
...
### Community 63 - "isDiskRedeemable"
Cohesion: 0.20
Nodes (15): getDiskReadCacheFlushSeconds(), getDiskRedeemTierName(), getMatchingTierForDiskSize(), getTierDiskRedeemCost(), hasFullRedeemableDiskAtSize(), isDiskAutoRedeemEligible(), isDiskCacheBlockAutoReleaseEligible(), isDiskCacheBlockManualReleaseAvailable() (+7 more)

### Community 64 - "App.test.jsx"
Cohesion: 0.10
Nodes (17): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, BITS_PER_BYTE, COMPUTE_BOOST_MAX_STACKS, COMPUTE_BOOST_PRESETS, COMPUTE_CORES_PER_NODE (+9 more)

### Community 65 - "formatCurrency"
Cohesion: 0.36
Nodes (9): formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getEonsAwarded(), RESOURCE_SYMBOL(), formatCost(), buildSparklinePath() (+1 more)
...
Cohesion: 0.18
Nodes (17): canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), getComputeBoostTierMultiplier(), getNextComputeMergeDurationUpgradeIndex() (+9 more)

### Community 68 - "getPrestigePointsAwarded"
Cohesion: 0.36
...
### Community 70 - "tickFoundryResetConvenience"
Cohesion: 0.25
Nodes (8): combineIntroByte(), getDiskLadderSizeBits(), getDiskSize(), isCapacityBelowCap(), isDiskBuildBelowCap(), isDiskLadderExhaustedForActivePools(), isInvestProgressBelowCap(), tickFoundryResetConvenience()
...
Cohesion: 0.10
Nodes (20): version, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED (+12 more)
...
### Community 75 - "canDepositDiskToDataLake"
Cohesion: 0.53
...
Cohesion: 0.25
Nodes (18): actFoundry(), activateComputeBoost(), eraseAllComputeTokens(), getDiskCost(), isBandwidthAvailable(), isBandwidthTurnAvailable(), isComputeBoostTurnAvailable(), isComputeCoreConversionUnlocked() (+10 more)
...
Cohesion: 0.16
Nodes (23): wouldAutobuyerStall(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getCostEpochExponent(), getPurchaseBlockSize(), getTierAffordableQuantity(), getTierBulkQuantity() (+15 more)
...
Cohesion: 0.17
Nodes (20): actTickspeed(), buyTickspeedMultiplier(), consumeXpForLastTierTickspeed(), countGlobalTickspeedMilestones(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierId(), getLastTierXpTickspeedMinConsumption() (+12 more)
...
### Community 97 - "eraEligibleState"
Cohesion: 0.67
Nodes (3): eraEligibleState(), withIntro(), withPrestigePoints()

## Knowledge Gaps
- **553 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+548 more)
