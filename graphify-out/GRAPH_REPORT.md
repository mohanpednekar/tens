...
## Corpus Check
- 108 files · ~408,253 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1590 nodes · 3981 edges · 102 communities (77 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2d821080`
...
Cohesion: 0.20
Nodes (20): applyFlopsAutobuyerMilestones(), createEmptyDataLakes(), normalizePoolMemoryCapacity(), applyDevGameStateJson(), applyPendingComputeGrants(), buildDefaultMeta(), coerceMeta(), defaultSlotName() (+12 more)
...
Cohesion: 0.07
Nodes (47): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost(), getIntroProductionMilestoneMaxClaims(), isBandwidthAvailable(), isBandwidthTurnAvailable() (+39 more)
...
Cohesion: 0.13
Nodes (21): actFoundry(), combineIntroByte(), eraseAllComputeTokens(), isDiskBuildBelowCap(), isDiskFillAvailable(), isInvestProgressBelowCap(), isMemoryCapacityAtCap(), isMemoryCapacityUpgradeAvailable() (+13 more)
...
Cohesion: 0.06
Nodes (49): activateComputeBoost(), canActivateComputeBoost(), canForfeitComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), forfeitComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds() (+41 more)
...
Cohesion: 0.08
Nodes (29): applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getTierTickspeedAutobuyerMilestone(), CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_CORES_PER_NODE (+21 more)
...
### Community 62 - "createInitialGameState"
Cohesion: 0.20
Nodes (11): seedState(), seedDataLakeSave(), allResourceIds(), buildEraIntroReset(), captureFoundryUpgradeCaps(), createInitialGameState(), eraGame(), mergeFoundryUpgradeCaps() (+3 more)
...
Cohesion: 0.05
Nodes (26): clearIntroCapacityUpgradeQueue(), getComputeBoostMultiplier(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getDataStreamBaseMultiplierPercent(), getDataStreamEffectMultiplier(), getDataStreamFillFraction(), getDataStreamMultiplierPercent() (+18 more)
...
Cohesion: 0.05
Nodes (102): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+94 more)
...
### Community 75 - "optimize-ai-files/SKILL.md"
Cohesion: 0.29
...
### Community 80 - "isProvisionDiskAvailable"
Cohesion: 0.18
Nodes (15): getDiskCost(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskSize(), getMaxActiveDiskLadderStep(), getNextDiskLadderSize(), getPoolBufferBits(), getProvisionDiskSeconds() (+7 more)
...
## Knowledge Gaps
- **655 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+650 more)
