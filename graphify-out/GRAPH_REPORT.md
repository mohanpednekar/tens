...
## Corpus Check
- 107 files · ~375,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1528 nodes · 3875 edges · 98 communities (74 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c38fa6e8`
...
Cohesion: 0.04
Nodes (51): applyOfflineProgress(), canForfeitComputeBoost(), enableAutoMergeCloudsIntoDatacenter, enableAutoMergeClustersIntoNetwork, enableAutoMergeCoresIntoNode, enableAutoMergeDatacentersIntoSupercomputer, enableAutoMergeFabricsIntoCloud, enableAutoMergeGridsIntoFabric (+43 more)
...
Cohesion: 0.05
Nodes (52): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, AUTOBUYER_UNLOCK_BASE_COST, AUTOBUYER_UNLOCK_MILESTONE_START, AUTOBUYER_UNLOCK_MILESTONE_STEP, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_FLOPS_TIER_BY_ID (+44 more)

### Community 3 - "ByteFoundryPage/index.jsx"
Cohesion: 0.07
Nodes (29): formatBitsInNearestUnit(), getMemoryUnit(), BITS_PER_BYTE, FILL_MULTIPLIER_TAP_CAP_PERCENT, ActionsRow, BalanceText, clampPercent(), DataStreamCard (+21 more)
...
Cohesion: 0.10
Nodes (19): CACHE_FILL_FROM_DISK_BANDWIDTH_MULTIPLIER, CACHE_FILL_FROM_MEMORY_BANDWIDTH_MULTIPLIER, COMPUTE_AUTO_BOOST_UNLOCK_COST, COMPUTE_BOOST_TIER_POWER_STEP, COMPUTE_FLOPS_LAST_TIER_COST_PP, COMPUTE_MERGE_CORE_EARN_MULTIPLIER, COMPUTE_MERGE_STEP_MULTIPLIER, DATA_LAKE_TRANSFER_BANDWIDTH_MULTIPLIER (+11 more)
...
### Community 8 - "getUnlockedStoragePoolCount"
Cohesion: 0.14
Nodes (21): getDecadePowerEquivalentBits(), getPoolBaseMultiplierPercent(), getPoolBufferBits(), getPoolBufferCapacity(), getPoolBufferFillFraction(), getPoolEffectMultiplier(), getPoolMultiplierPercent(), getPoolTapBonusPercent() (+13 more)
...
Cohesion: 0.06
Nodes (50): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, captureFoundryUpgradeCaps(), clearIntroCapacityUpgradeQueue(), COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, getComputeFlopsTierProductionMultiplier() (+42 more)
...
### Community 39 - "isDiskRedeemable"
Cohesion: 0.18
Nodes (17): getDiskRequiredTierLevel(), getDiskWriteCacheMerge(), getMatchingTierForDiskSize(), hasFullRedeemableDiskAtSize(), isDiskAutoRedeemEligible(), isDiskCacheBlockAutoReleaseEligible(), isDiskCacheBlockManualReleaseAvailable(), isDiskCacheBlockReleasable() (+9 more)
...
Cohesion: 0.06
Nodes (33): getNextComputeMergeDurationUpgradeIndex(), COMPUTE_MERGE_RESERVE_CAP, COMPUTE_MERGE_STEP_MULTIPLIER_UPGRADED, ActiveBoostRow, ArmedStatusText, AutoBoostLabel, AutoBoostRow, BoostRow (+25 more)

### Community 51 - "getStoragePoolBandwidth"
Cohesion: 0.22
Nodes (14): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskCost(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getPoolIndexForDiskSize(), getProvisionDiskBaseSeconds() (+6 more)

### Community 52 - "ComputeFlopsPage/index.jsx"
Cohesion: 0.11
Nodes (26): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), flooredBitsLabel(), floorToDecimals(), formatAmount(), formatBitsInNearestSiUnit(), formatComputeFlopsBoost() (+18 more)

### Community 53 - "App.test.jsx"
Cohesion: 0.11
Nodes (15): ALL_TIER_IDS, derivePurchaseFieldsFromCounts(), seedMainGameState(), AUTO_PRESTIGE_AUTOBUYER_COST, COMPUTE_BOOST_MAX_STACKS, COMPUTE_CORES_PER_NODE, COMPUTE_ENTITY_CAP, DATA_LAKE_CAPACITY_MAX_LEVEL (+7 more)

### Community 54 - "MilestonesPage/index.jsx"
Cohesion: 0.11
Nodes (18): VisuallyHidden, NoticeText, OfflineNoticeCard, OfflineNoticeOverlay, OfflineProgressNotice(), StatCard, getFlopsAutobuyerUnlockEra(), COMPUTE_FLOPS_TIER_DEFINITIONS (+10 more)
...
### Community 58 - "activateComputeBoost"
Cohesion: 0.25
Nodes (11): activateComputeBoost(), canReclaimComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostMultiplier(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), getComputeBoostTierMultiplier(), isValidComputeBoostTier() (+3 more)
...
Cohesion: 0.09
Nodes (27): CacheBlock, CacheBlocksRow, CacheFlushFill, CellLabel, DiskArrayRow(), DiskSizeRow, DiskSquare, manualPulse (+19 more)
...
Cohesion: 0.16
Nodes (18): countGlobalTickspeedMilestones(), getAutoPrestigeAttemptRate(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getNextBytePowerProgressFraction(), getOverclockMultiplier(), getPrestigeProductionMultiplier() (+10 more)
...
Cohesion: 0.11
Nodes (26): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+18 more)

### Community 67 - "DevModePage/index.jsx"
Cohesion: 0.11
Nodes (23): PRESTIGE_THRESHOLD, TIER_DEFINITIONS, ButtonGrid, coerceDraft(), Details, DevModePage(), FieldLabel, FieldNode() (+15 more)

### Community 68 - "navAttention.test.js"
Cohesion: 0.11
Nodes (17): AUTO_SPEED_UP_COST, BYTES_ID, COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC, COMPUTE_FLOPS_FIRST_TIER_COST_PP, COMPUTE_MERGE_RATIO, DEFAULT_PURCHASE_BLOCK_SIZE, INTRO_BYTE_COMBINE_COST, INTRO_CONVERSION_UNLOCK_CAPACITY (+9 more)

### Community 69 - "ByteFoundryPage"
Cohesion: 0.21
Nodes (17): applyIntroProductionDoublingToIntro(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskRedeemTierName(), getDiskSize(), getDiskSizesToShow(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost() (+9 more)
...
Cohesion: 0.08
Nodes (47): BalanceText, BareDivider, clampPercent(), DataLakePanel(), FillableStatCard, getVisibleLakeTierIndexes(), LakeActionsRow, LakeBlock (+39 more)

### Community 72 - "actFoundry"
Cohesion: 0.20
Nodes (12): actFoundry(), canStartBoosterTransfer(), combineIntroByte(), eraseAllComputeTokens(), isInvestProgressBelowCap(), pickIntroCapacityMilestone(), rewindOneIntroProductionClaim(), rollbackComputeFundedBandwidth() (+4 more)

### Community 73 - "INTRO_COMPUTE_CORE_UNLOCK_CAPACITY"
Cohesion: 0.50
...
Cohesion: 0.18
Nodes (24): wouldAutobuyerStall(), buyTickspeedMultiplier(), buyTier(), buyTierQuantity(), convertIntroBitsToKilobytes(), getCostEpochExponent(), getIntroKilobyteConversionCost(), getLastTierId() (+16 more)
...
Cohesion: 0.07
Nodes (66): canActivateComputeBoost(), canStackComputeBoost(), enableAutoMerge(), isAnyDataLakeCapacityDoublingAvailable(), isAutoMergeCloudsIntoDatacenterUnlockAvailable(), isAutoMergeClustersIntoNetworkUnlockAvailable(), isAutoMergeCoresIntoNodeUnlockAvailable(), isAutoMergeDatacentersIntoSupercomputerUnlockAvailable() (+58 more)

### Community 86 - "formatOfflineDuration"
Cohesion: 0.28
Nodes (9): seedState(), applyAutobuyerMilestones(), formatOfflineDuration(), getAutobuyerUnlockMilestone(), getTierTickspeedAutobuyerMilestone(), isEraEligible(), prestigeGame(), InfoPage() (+1 more)
...
## Knowledge Gaps
- **611 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+606 more)
