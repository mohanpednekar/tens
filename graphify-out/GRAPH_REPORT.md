...
### Community 32 - "isStorageUnlocked"
Cohesion: 0.14
...
### Community 40 - "isProductionFrozen"
Cohesion: 0.20
...
- **Why does `main()` connect `main` to `isStorageUnlocked`, `Key engine functions (`src/game/engine.js`)`, `Economy model`, `Byte Foundry`, `Testing`, `ByteFoundryPage/index.jsx`, `Automation workflows`, `DataLakePanel/index.jsx`, `provisionDisk`, `bump-version.mjs`, `file-task-issue/SKILL.md`, `useIncrementalGame`, `CLAUDE.md`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `Design history & rationale` connect `provisionDisk` to `isStorageUnlocked`, `Testing`, `Economy model`, `Key engine functions (`src/game/engine.js`)`, `ComputePage/index.jsx`, `Automation workflows`, `isProductionFrozen`, `DataLakePanel/index.jsx`, `tickGame`, `Tens`, `getStoragePoolMemoryBounds`, `App.jsx`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `[Unreleased]` connect `[Unreleased]` to `isStorageUnlocked`, `DataLakePanel/index.jsx`, `provisionDisk`, `Button/index.jsx`, `SettingsPage/index.jsx`?**
