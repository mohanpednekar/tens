...
## Corpus Check
- 107 files · ~397,800 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1571 nodes · 3969 edges · 105 communities (81 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9a6d94f6`
...
Cohesion: 0.07
Nodes (34): ActionsRow, BalanceText, clampGaugeValue(), clampPercent(), DataStreamCard, FillableStatCard, gaugeArcPath(), GaugeBaseArc (+26 more)
...
### Community 8 - "pickIntroProductionMilestone"
Cohesion: 0.36
...
Cohesion: 0.16
Nodes (27): buyAutoPrestige(), buyTierQuantity(), checkMilestones(), clampNonNegative(), getAutoPrestigeAttemptRate(), getAutoPrestigeCost(), getComputeFlopsTierProductionMultiplier(), getCostEpochExponent() (+19 more)
...
Cohesion: 0.05
Nodes (83): applyOfflineProgress(), AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyHyperscaler(), buyPrestigeDoublePp() (+75 more)
...
Cohesion: 0.12
Nodes (16): Actions, Body, Card, ConfirmDialog(), Overlay, Title, StatCard, Badge (+8 more)
...
### Community 58 - "MainPage"
Cohesion: 0.15
Nodes (22): countGlobalTickspeedMilestones(), getEffectiveTierTickSpeedSeconds(), getGlobalTickspeedProductionMultiplier(), getLastTierXpTickspeedMultiplier(), getMoneyExponent(), getNextBytePowerProgressFraction(), getOverclockMultiplier(), getPrestigeDoublePpHalvingLevels() (+14 more)
...
Cohesion: 0.14
Nodes (16): actFoundry(), convertIntroBitsToKilobytes(), eraseAllComputeTokens(), getDataStreamMultiplierPercent(), getPoolCapacityUnlockThresholdBits(), getVisibleStoragePoolCount(), isStorageUnlocked(), latchMainGameUnlocked() (+8 more)
...
Cohesion: 0.05
Nodes (25): getComputeBoostMultiplier(), getComputeMergeDurationSeconds(), getCoreEarnTimeSeconds(), getDataStreamEffectMultiplier(), startComputeMergeReserve(), startComputeMergeReserveAtBoundary(), eraEligibleState(), noOtherUpgradesLeft (+17 more)

### Community 66 - "getStoragePoolBandwidth"
Cohesion: 0.13
Nodes (26): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDecadePowerEquivalentBits(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolBufferCapacity() (+18 more)
...
Cohesion: 0.23
Nodes (12): getDataLakeSubSize(), getDataLakeTierIndex(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskRequiredTierLevel(), getIdleDiskLiquidationSizes(), getNextDiskLadderSize(), isDiskArrayFullyBuilt() (+4 more)

### Community 73 - "isAutoMergeUnlockAvailable"
Cohesion: 0.18
...
### Community 84 - "provisionDisk"
Cohesion: 0.22
Nodes (10): combineIntroByte(), getDiskSize(), getMaxActiveDiskLadderStep(), getProvisionDiskBaseSeconds(), getProvisionDiskSeconds(), isDiskBuildBelowCap(), isInvestProgressBelowCap(), provisionDisk() (+2 more)

### Community 85 - "buyTickspeedMultiplier"
Cohesion: 0.48
...
### Community 96 - "ByteFoundryPage"
Cohesion: 0.15
Nodes (30): activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField(), getComputeBoostTierMultiplier() (+22 more)

### Community 97 - "getDataStreamBaseMultiplierPercent"
Cohesion: 0.47
...
## Knowledge Gaps
- **632 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+627 more)
