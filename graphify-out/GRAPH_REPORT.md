...
## Corpus Check
- 107 files · ~338,430 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1482 nodes · 3741 edges · 101 communities (82 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `339de1b3`
...
Cohesion: 0.17
Nodes (15): getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), isUnboundedPrestigeUnlocked(), InfoPage(), Badge, Category, CategoryHeading (+7 more)
...
Cohesion: 0.06
Nodes (49): AUTO_PRESTIGE_BASE_INTERVAL_SECONDS, AUTO_PRESTIGE_COST, AUTO_PRESTIGE_COST_MULTIPLIER, COMPUTE_BOOST_TIER_DURATION_STEP, COMPUTE_BOOST_TIER_FIELDS, COMPUTE_FLOPS_TIER_BY_ID, COMPUTE_FLOPS_TIER_DEFINITIONS, COMPUTE_FLOPS_TIER_INDEX_BY_ID (+41 more)
...
Cohesion: 0.17
Nodes (20): activateComputeBoost(), canActivateComputeBoost(), canReclaimComputeBoost(), canStackComputeBoost(), canStartBoosterTransfer(), getBiggestComputeTierWaitingOnMerge(), getComputeBoostTierDurationSeconds(), getComputeBoostTierField() (+12 more)
...
### Community 15 - "isAutoMergeUnlockAvailable"
Cohesion: 0.18
...
Cohesion: 0.27
Nodes (12): App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), isComputeFlopsPageRevealed(), getComputeFlopsAttentionLevel(), getNavAttention(), hasAffordableComputeFlopsTier() (+4 more)
...
Cohesion: 0.08
Nodes (23): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, COMPUTE_MERGE_TIMER_FIELDS, currencyNumberFormatter, DATA_LAKE_SUB_SIZE_TOTAL, formatBitsInNearestSiUnit(), getSiByteUnit(), MEMORY_BINARY_UNIT_SYMBOLS (+15 more)
...
Cohesion: 0.24
Nodes (12): combineIntroByte(), getDiskCost(), getDiskSize(), getMaxActiveDiskLadderStep(), getPoolBufferBits(), isDiskBuildBelowCap(), isDiskLadderExhaustedForActivePools(), isInvestProgressBelowCap() (+4 more)
...
Cohesion: 0.14
Nodes (26): BareDivider, CapacityCell, DataLakePanel(), DoubleCapacityButton, getVisibleLakeTierIndexes(), LakeGrid, LakeHeaderRow, LakeName (+18 more)

### Community 66 - "navAttention.js"
Cohesion: 0.05
Nodes (108): actMainBuys(), actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges (+100 more)

### Community 67 - "engine.test.js"
Cohesion: 0.05
Nodes (14): canForfeitComputeBoost(), clearIntroCapacityUpgradeQueue(), forfeitComputeBoost(), getComputeBoostMultiplier(), getComputeBoostTierMultiplier(), isAnyComputeMergeInFlight(), isUpgradeComputeMergeDurationAvailable(), releaseDiskCacheBlock() (+6 more)

### Community 68 - "actFoundry"
Cohesion: 0.21
Nodes (12): actFoundry(), eraseAllComputeTokens(), isMemoryCapacityAtCap(), isMemoryCapacityUpgradeAvailable(), isPoolCapacityUpgradeAvailable(), pickIntroCapacityMilestone(), queueIntroCapacityUpgrade(), rewindOneIntroProductionClaim() (+4 more)
...
Cohesion: 0.29
Nodes (11): isBandwidthTurnAvailable(), isDiskFillAvailable(), isIntroConversionUnlocked(), isStorageUnlocked(), getFoundryAttentionLevel(), getStorageAttentionLevel(), hasFoundryAttention(), hasStorageAttention() (+3 more)
...
Cohesion: 0.18
Nodes (19): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDiskReadCacheFlushSeconds(), getDiskWriteCacheFlushSeconds(), getDiskWriteCacheSegmentSeconds(), getIntroProductionRate(), getPoolBufferCapacity(), getPoolIndexForDiskSize() (+11 more)
...
### Community 85 - "AppNav/index.jsx"
Cohesion: 0.20
Nodes (9): APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar, Icon, Label, NavItem, pulseHigh (+1 more)

### Community 86 - "isDataLakeCapacityDoublingTurnAvailable"
Cohesion: 0.24
Nodes (10): getDataLakeAvailableUnits(), getPoolLastDiskSize(), isAnyDataLakeCapacityDoublingAvailable(), isDataLakeCapacityDoublingAvailable(), isDataLakeCapacityDoublingTurnAvailable(), isDataLakeCapacityMaxed(), isIdleDiskLiquidationAvailable(), isIdleDiskLiquidationTurnAvailable() (+2 more)
