...
## Corpus Check
- 107 files · ~402,814 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1572 nodes · 3961 edges · 100 communities (76 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b20f6b13`
...
Cohesion: 0.06
Nodes (74): seedState(), seedDataLakeSave(), allResourceIds(), applyFlopsAutobuyerMilestones(), buildEraIntroReset(), createEmptyDataLakes(), createEmptyDataLakeTier(), createInitialGameState() (+66 more)
...
Cohesion: 0.07
Nodes (29): ActionsRow, BalanceText, clampPercent(), DataStreamCard, FillableStatCard, GaugeBaseArc, GaugeBonusArc, GaugeHub (+21 more)
...
Cohesion: 0.16
Nodes (19): getDataLakeSubSize(), getDiskReadCacheFlush(), getDiskRequiredTierLevel(), getDiskWriteCacheMerge(), getMatchingTierForDiskSize(), hasFullRedeemableDiskAtSize(), isDiskAutoRedeemEligible(), isDiskCacheBlockAutoReleaseEligible() (+11 more)
...
### Community 8 - "StoragePage/index.jsx"
Cohesion: 0.40
...
Cohesion: 0.10
Nodes (32): canStartDiskWriteCacheMerge(), decrementFullDiskCount(), getDataLakeTierIndex(), getDecadePowerEquivalentBits(), getDiskLadderSizeBits(), getDiskLadderStep(), getDiskReadCacheFlushSeconds(), getDiskSize() (+24 more)
...
Cohesion: 0.17
Nodes (27): actMainBuys(), wouldAutobuyerStall(), buyTier(), buyTierQuantity(), checkMilestones(), clampNonNegative(), getAutoPrestigeAttemptRate(), getComputeFlopsTierProductionMultiplier() (+19 more)

### Community 48 - "ByteFoundryPage"
Cohesion: 0.15
Nodes (27): applyIntroProductionDoublingToIntro(), eraseAllComputeTokens(), getComputeBandwidthSacrificeField(), getComputeBandwidthSacrificeLabel(), getDiskRedeemTierName(), getDiskSizesToShow(), getEffectiveComputeBandwidthSacrificeIndex(), getIntroProductionMilestoneCost() (+19 more)
...
Cohesion: 0.04
Nodes (63): applyOfflineProgress(), buyAutoPrestige(), buyAutoPrestigeAutobuyer(), buyAutoSpeedUp(), buyComputeAutoBoost(), buyPrestigeDoublePp(), buySmartAutobuyer(), buyTickspeedAutobuyer() (+55 more)
...
Cohesion: 0.16
Nodes (17): applyAutobuyerMilestones(), getAutobuyerUnlockMilestone(), getFlopsAutobuyerUnlockEra(), getTierTickspeedAutobuyerMilestone(), isEraEligible(), isUnboundedPrestigeUnlocked(), InfoPage(), Badge (+9 more)
...
Cohesion: 0.14
Nodes (17): actFoundry(), combineIntroByte(), convertIntroBitsToKilobytes(), getDataStreamEffectMultiplier(), getDataStreamMultiplierPercent(), getIntroProductionRate(), getPoolCapacityUnlockThresholdBits(), getProvisionDiskSeconds() (+9 more)
...
Cohesion: 0.14
Nodes (17): App(), GATE_EXEMPT_PAGES, PageShell, resolveInitialThemeMode(), APP_NAV_BOTTOM_PAD, AppNav(), AttentionDot, Bar (+9 more)

### Community 66 - "engine.js"
Cohesion: 0.07
Nodes (44): AUTO_MERGE_TICKERS, BIT_UNIT_SYMBOLS, buyBooster(), buyHyperscaler(), canBuyHyperscaler(), captureFoundryUpgradeCaps(), clearIntroCapacityUpgradeQueue(), COMPUTE_MERGE_TIMER_FIELDS (+36 more)

### Community 67 - "navAttention.js"
Cohesion: 0.08
Nodes (45): enableAutoMerge(), getIntroKilobyteConversionCost(), isAutoMergeCloudsIntoDatacenterUnlockAvailable(), isAutoMergeClustersIntoNetworkUnlockAvailable(), isAutoMergeCoresIntoNodeUnlockAvailable(), isAutoMergeDatacentersIntoSupercomputerUnlockAvailable(), isAutoMergeFabricsIntoCloudUnlockAvailable(), isAutoMergeGridsIntoFabricUnlockAvailable() (+37 more)
...
Cohesion: 0.10
Nodes (37): actPlayer(), actSoftResets(), actSpeedBonus(), actTickspeed(), countUnlockedAutobuyers(), DEFAULT_CAPACITY_CAPS_BITS, defaultCareerPrestiges, defaultPPValues (+29 more)
...
Cohesion: 0.14
Nodes (19): Money, buyComputeFlopsTier(), canBuyComputeFlopsTier(), formatComputeFlopsBoost(), formatComputeFlopsTotal(), getComputeFlopsTierCost(), getComputeFlopsTierWeight(), getComputeFlopsTotal() (+11 more)
...
Cohesion: 0.16
Nodes (24): countGlobalTickspeedMilestones(), formatAmount(), formatAsCleanBytesIfExactMultiple(), formatBytes(), formatCurrency(), formatMoneyBalance(), formatScientific(), getAutoPrestigeCost() (+16 more)
...
## Knowledge Gaps
- **639 isolated node(s):** `session-start.sh script`, `publish-strategy.sh script`, `DEFAULT_CAPACITY_CAPS_BITS`, `defaultPPValues`, `defaultCareerPrestiges` (+634 more)
