    ...
    <RootDiv>
      ...
      <Section aria-label="compute flops section">
        ...
        <p>
          ...
          <strong>KFlops → QFlops</strong>, each boosting the matching Data tier. Reveals once
        ...
        <ul>
          <li>
            Base costs follow the same 10³ ladder as Data tiers (
            ...
            curve as Data tiers, but not gated behind 8-purchase level blocks).
          </li>
          <li>
            Each owned unit adds{' '}
            {(COMPUTE_FLOPS_BOOST_RATE_PER_UNIT_PER_SEC * 100).toFixed(2)}% per real second to its
            matching Data tier — linear in owned count, applied as production multiplier{' '}
      ...
      <Section aria-label="era ascension section">
        ...
        <ul>
          ...
          <li>
            ...
            Disks, Compute entities, ordinary Data cycle (resources, owned tiers, Double PP
