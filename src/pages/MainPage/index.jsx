          ...
          return (
            ...
            >
              ...
              <BuyButton
                ...
                title={`Buy ${tier.name} to increase your ${RESOURCE_SYMBOL(tier.producesResourceId)} production — completing every level (${purchaseBlockSize} purchases) also multiplies it by ×${PURCHASE_MILESTONE_MULTIPLIER_BASE}`}
                    ...
                    {isTierTickspeedAutobuyerActive ? (
                      <UpgradeRowControls>
                        ...
                        <PauseToggleButton
                          ...
                          aria-label={`${tier.name}'s tickspeed autobuyer`}
                      ...
                      {!isAutobuyerLocked && (
                        <UpgradeRowControls>
                          ...
                          <PauseToggleButton
                            ...
                            aria-label={`${tier.name}'s autobuyer`}
              ...
              {isTickspeedAutobuyerActive ? (
                <UpgradeRowControls>
                  ...
                  <PauseToggleButton
                    ...
                    aria-label="Tickspeed Autobuyer automation"
              ...
              {isAutoScaleUpActive ? (
                <UpgradeRowControls>
                  ...
                  <PauseToggleButton
                    ...
                    aria-label="Auto Scale Up automation"
                ...
                {isAutoPrestigeAutobuyerActive ? (
                  <UpgradeRowControls>
                    ...
                    <PauseToggleButton
                      ...
                      aria-label="Auto-Prestige Autobuyer automation"
                ...
                <UpgradeRowControls>
                  ...
                  {isAutoPrestigeActive && (
                    <PauseToggleButton
                      ...
                      aria-label="Auto-Prestige automation"
