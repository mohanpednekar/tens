...
// Second-level tabs on Ladder: Data | Upgrades (peer tabs — no back chrome). Milestones lives
...
const MainPage = ({ game, focusNonce = 0 }) => {
  ...
  // the tier ladder is the default Ladder screen, and Milestones lives under AppNav → More. Upgrades
  ...
  // hasAffordablePpUpgrade in game/navAttention.js (shared with AppNav's Ladder attention level).
  ...
  return (
    <RootDiv>
      ...
      {/* Second-level Ladder tabs: Data | Upgrades (no back button). Milestones is under More.
