...
// Bottom bar order follows play progression: Foundry → Compute → Ladder, then Guide / More.
...
// Accessible names: open byte foundry / open compute / open ladder / open guide / open more menu.
...
const AppNav = ({
  ...
  // Progression order: Foundry family → Compute → Ladder → utilities.
  const items = [
    ...
    showTiers && { id: 'game', ariaLabel: 'open ladder', icon: '📶', label: 'Ladder', title: 'Production ladder — buy and produce' },
