...
// Deposited/Bought/Next columns line up vertically instead of each row wrapping/aligning
...
// and nesting a second card here would double-box the same content.
  ...
  const list = (
    <LakeGrid>
      ...
      {visibleTiers.map(tierIndex => {
        ...
        const capacitySize = formatDiskSize(getDataLakeCapacity() * unitBits)
        ...
        return (
          <LakeRow key={tierIndex}>
            ...
            <LakeStat>{`${depositedSize}/${capacitySize}`}</LakeStat>
