...
import {
  ...
  COMPUTE_ENTITY_CAP,
  COMPUTE_MERGE_BASE_DURATION_SECONDS,
...
describe('constants', () => {
  ...
  it('COMPUTE_MERGE_DURATIONS_SECONDS is the unupgraded 1s × 10^n chain (9 steps)', () => {
    expect(COMPUTE_MERGE_BASE_DURATION_SECONDS).toBe(1)
    ...
    expect(COMPUTE_MERGE_DURATIONS_SECONDS).toEqual([1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000])
  })
