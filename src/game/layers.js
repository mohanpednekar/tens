// Each tier costs the lower-layer resource it produces, so every step in the
// chain is earned by the tier directly below it.
export const TIER_DEFINITIONS = [
  // Each tier spends the same resource type it generates.
