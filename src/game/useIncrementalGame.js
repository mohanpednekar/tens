...
export const useIncrementalGame = () => {
  ...
  const actions = useMemo(() => ({
    ...
    buyBooster: tierIndex => setState(buyBooster(tierIndex)),
    fillDataLakeManually: tierIndex => setState(fillDataLakeManually(tierIndex)),
    toggleDataLakeAutoBuy: tierIndex => setState(toggleDataLakeAutoBuy(tierIndex)),
