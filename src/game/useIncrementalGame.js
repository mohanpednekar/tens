...
export const useIncrementalGame = () => {
  ...
  const actions = useMemo(() => ({
    ...
    startBoosterTransfer: tierIndex => setState(startBoosterTransfer(tierIndex)),
