...
/**
 * Confirm copy for wiping only Byte Foundry / Storage / Boosters on the active save.
...
export const buildResetByteFoundryConfirmMessage = () => {
  ...
  return (
    ...
    `Use this if Capacity (or Storage / Boosters) went too far.\n\n` +
    `Erased: Memory, Capacity, Combine / Invest / Bandwidth progress, all Disks/Storage, and all Boosters progress. Multipliers restart from scratch.\n\n` +
