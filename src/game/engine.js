...
// Helper to implement SI-round memory bounds switchover. See docs/DESIGN_HISTORY.md and
// POOL_CAPACITY_SI_STEP in layers.js for context. A pure capacity doubling sequence gets
// deviated from 64 to 125, instead of 128, once per 1000-multiple magnitude.
...
// permanently hard-capped at DATA_LAKE_CAPACITY_MAX_LEVEL (1,000 units at level 10).
...
const DATA_LAKE_CAPACITY_BY_LEVEL = [1, 2, 4, 8, 16, 32, 64, 125, 250, 500, 1000]
