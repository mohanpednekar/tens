...
describe('Claim Core (ByteFoundryPage)', () => {
  ...
  test('after Boosts unlocks, Claim Core sits in Memory ×2\'s former milestones slot and Memory ×2 moves below disks', () => {
    seedIntroState({
      bits: 0,
      capacity: INTRO_COMPUTE_CORE_UNLOCK_CAPACITY,
      byteCreated: true,
    ...
    // Claim Core + Bandwidth share the milestones row (Claim before Bandwidth); Memory ×2 is
  ...
  test('before Boosts unlocks, Memory ×2 stays beside Bandwidth and Claim Core is absent', () => {
    seedIntroState({ bits: 0, capacity: INTRO_DISK_UNLOCK_CAPACITY, byteCreated: true })
    render(<App />)
